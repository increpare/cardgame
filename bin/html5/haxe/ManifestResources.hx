...
@:keep @:bind #if display private #end class __ASSET__data_graphics_bilder_wueste_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__data_graphics_bilder_steppe_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:image("data/graphics/bilder/wueste.png") #if display private #end class __ASSET__data_graphics_bilder_wueste_png extends lime.graphics.Image {}
@:image("data/graphics/bilder/steppe.png") #if display private #end class __ASSET__data_graphics_bilder_steppe_png extends lime.graphics.Image {}
