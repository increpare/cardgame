...
@:keep @:dox(hide) class ManifestResources {
	...
	public static function init (config:Config):Void {
		...
		data = '{"name":null,"assets":"aoy4:pathy43:data%2Fgraphics%2Ffonts%2Fpixel%2Fpixel.fnty4:sizei20629y4:typey4:TEXTy2:idR1y7:preloadtgoR0y45:data%2Fgraphics%2Ffonts%2Fpixel%2Fpixel_0.pngR2i2405R3y5:IMAGER5R7R6tgh","version":2,"libraryArgs":[],"libraryType":null}';
