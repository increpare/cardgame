...
class HXCPP_CLASS_ATTRIBUTES TextureAtlas_obj : public hx::Object
{
	...
	public:
		...
		void __construct( ::starling::textures::Texture texture, ::Dynamic atlasXml);
		...
		static hx::ObjectPtr< TextureAtlas_obj > __new( ::starling::textures::Texture texture, ::Dynamic atlasXml);
		static hx::ObjectPtr< TextureAtlas_obj > __alloc(hx::Ctx *_hx_ctx, ::starling::textures::Texture texture, ::Dynamic atlasXml);
