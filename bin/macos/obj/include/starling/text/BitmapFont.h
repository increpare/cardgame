...
class HXCPP_CLASS_ATTRIBUTES BitmapFont_obj : public hx::Object
{
	...
	public:
		...
		void __construct( ::starling::textures::Texture texture, ::Dynamic fontXml);
		...
		static hx::ObjectPtr< BitmapFont_obj > __new( ::starling::textures::Texture texture, ::Dynamic fontXml);
		static hx::ObjectPtr< BitmapFont_obj > __alloc(hx::Ctx *_hx_ctx, ::starling::textures::Texture texture, ::Dynamic fontXml);
