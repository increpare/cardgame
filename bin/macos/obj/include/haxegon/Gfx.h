...
class HXCPP_CLASS_ATTRIBUTES Gfx_obj : public hx::Object
{
	...
	public:
		...
		static bool changetileset(::String tilesetname);
		...
		static bool loadimage(::String imagename);
		...
		static void resizescreen(Float width,Float height,hx::Null< bool >  keeppixelratio);
		...
		static ::Dynamic onwindowresized_dyn();

		static bool _onwindowresized;
		...
		static bool _keeppixelratio;
		static bool drawtolocked;
};
