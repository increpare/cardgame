...
class HXCPP_CLASS_ATTRIBUTES Core_obj : public  ::starling::display::Sprite_obj
{
	...
	public:
		...
		static  ::haxe::ds::StringMap installedplugins;
		static ::String WINDOW_WIDTH;
		static ::String WINDOW_HEIGHT;
		static void registerplugin(::String pluginname,::String pluginversion);
		static ::Dynamic registerplugin_dyn();

		static void checkrequirement(::String currentplugin,::String requiredplugin,::String requiredversion);
		static ::Dynamic checkrequirement_dyn();
