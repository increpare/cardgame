...
class HXCPP_CLASS_ATTRIBUTES Data_obj : public hx::Object
{
	...
	public:
		...
		static int width;
		static int height;
		static  ::Dynamic loadjson(::String jsonfile);
		static ::Dynamic loadjson_dyn();

		static void sanitisefields( ::Dynamic j);
		static ::Dynamic sanitisefields_dyn();

		static void populatefields( ::Dynamic j);
		static ::Dynamic populatefields_dyn();

		static  ::Dynamic xmltojson( ::Xml x);
		static ::Dynamic xmltojson_dyn();

		static  ::Dynamic loadxml(::String xmlfile);
