...
class HXCPP_CLASS_ATTRIBUTES Random_obj : public hx::Object
{
	...
	public:
		...
		static  ::Dynamic weighted(::cpp::VirtualArray options,::Array< int > odds);
		static ::Dynamic weighted_dyn();
		...
		static  ::Dynamic _seed;
		static  ::Dynamic get_seed();
		static ::Dynamic get_seed_dyn();

		static  ::Dynamic set_seed( ::Dynamic s);
		...
		static int gen31();
		static ::Dynamic gen31_dyn();

		static int gen32();
		static ::Dynamic gen32_dyn();

		static int rand(int n);
		static ::Dynamic rand_dyn();

		static int randinterval(int min,int max, ::Dynamic includeMax);
		static ::Dynamic randinterval_dyn();

		static int _hx_INT_MAX;
		static Float INT_MAXPLUSONE;
};
