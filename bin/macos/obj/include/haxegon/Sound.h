...
class HXCPP_CLASS_ATTRIBUTES Sound_obj : public hx::Object
{
	...
	public:
		...
		static void __boot();
		static bool load(::String soundname,hx::Null< Float >  adjustvolume);
		static ::Dynamic load_dyn();

		static void offset(::String soundname,hx::Null< Float >  offsettime);
		...
		static  ::haxe::ds::StringMap offsetindex;
};
