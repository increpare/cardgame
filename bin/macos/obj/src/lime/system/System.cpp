...
static const ::String _hx_array_data_acbd8395_18[] = {
...
static const ::String _hx_array_data_acbd8395_28[] = {
...
HXLINE( 631)			::lime::_hx_system::System_obj::_hx___deviceModel = ::lime::_hx_system::System_obj::_hx___runProcess(HX_("sysctl",ae,bd,d5,f2),::Array_obj< ::String >::fromData( _hx_array_data_acbd8395_18,2));
            		}
...
HXLINE( 655)			::lime::_hx_system::System_obj::_hx___deviceVendor = HX_("Apple",3a,f5,68,b7);
            		}
...
HXLINE( 750)			::String name = ::lime::_hx_system::System_obj::get_platformName();
HXLINE( 751)			::String version = ::lime::_hx_system::System_obj::get_platformVersion();
HXLINE( 752)			bool _hx_tmp;
HXDLIN( 752)			if (hx::IsNotNull( name )) {
HXLINE( 752)				_hx_tmp = hx::IsNotNull( version );
            			}
            			else {
HXLINE( 752)				_hx_tmp = false;
            			}
HXDLIN( 752)			if (_hx_tmp) {
HXLINE( 752)				::lime::_hx_system::System_obj::_hx___platformLabel = ((name + HX_(" ",20,00,00,00)) + version);
            			}
            			else {
HXLINE( 753)				if (hx::IsNotNull( name )) {
HXLINE( 753)					::lime::_hx_system::System_obj::_hx___platformLabel = name;
            				}
            			}
            		}
...
HXLINE( 770)			::lime::_hx_system::System_obj::_hx___platformName = HX_("macOS",73,51,16,03);
            		}
...
HXLINE( 817)			::lime::_hx_system::System_obj::_hx___platformVersion = ::lime::_hx_system::System_obj::_hx___runProcess(HX_("sw_vers",6b,99,f9,43),::Array_obj< ::String >::fromData( _hx_array_data_acbd8395_28,1));
            		}
