...
HX_DEFINE_STACK_FRAME(_hx_pos_fd8eaa6e8425d4a1_44_new,"starling.events.TouchMarker","new",0xed1cf7bc,"starling.events.TouchMarker.new","starling/events/TouchMarker.hx",44,0x767a3d54)
HX_LOCAL_STACK_FRAME(_hx_pos_fd8eaa6e8425d4a1_61_dispose,"starling.events.TouchMarker","dispose",0xda1285fb,"starling.events.TouchMarker.dispose","starling/events/TouchMarker.hx",61,0x767a3d54)
HX_LOCAL_STACK_FRAME(_hx_pos_fd8eaa6e8425d4a1_67_moveMarker,"starling.events.TouchMarker","moveMarker",0x7679abcf,"starling.events.TouchMarker.moveMarker","starling/events/TouchMarker.hx",67,0x767a3d54)
HX_LOCAL_STACK_FRAME(_hx_pos_fd8eaa6e8425d4a1_81_moveCenter,"starling.events.TouchMarker","moveCenter",0xc1e45bea,"starling.events.TouchMarker.moveCenter","starling/events/TouchMarker.hx",81,0x767a3d54)
HX_LOCAL_STACK_FRAME(_hx_pos_fd8eaa6e8425d4a1_88_createTexture,"starling.events.TouchMarker","createTexture",0xdb72139b,"starling.events.TouchMarker.createTexture","starling/events/TouchMarker.hx",88,0x767a3d54)
HX_LOCAL_STACK_FRAME(_hx_pos_fd8eaa6e8425d4a1_113_get_realMarker,"starling.events.TouchMarker","get_realMarker",0xe6e33625,"starling.events.TouchMarker.get_realMarker","starling/events/TouchMarker.hx",113,0x767a3d54)
HX_LOCAL_STACK_FRAME(_hx_pos_fd8eaa6e8425d4a1_115_get_mockMarker,"starling.events.TouchMarker","get_mockMarker",0xabac6651,"starling.events.TouchMarker.get_mockMarker","starling/events/TouchMarker.hx",115,0x767a3d54)
HX_LOCAL_STACK_FRAME(_hx_pos_fd8eaa6e8425d4a1_118_get_realX,"starling.events.TouchMarker","get_realX",0x0abb17ed,"starling.events.TouchMarker.get_realX","starling/events/TouchMarker.hx",118,0x767a3d54)
HX_LOCAL_STACK_FRAME(_hx_pos_fd8eaa6e8425d4a1_120_get_realY,"starling.events.TouchMarker","get_realY",0x0abb17ee,"starling.events.TouchMarker.get_realY","starling/events/TouchMarker.hx",120,0x767a3d54)
HX_LOCAL_STACK_FRAME(_hx_pos_fd8eaa6e8425d4a1_123_get_mockX,"starling.events.TouchMarker","get_mockX",0x3057d741,"starling.events.TouchMarker.get_mockX","starling/events/TouchMarker.hx",123,0x767a3d54)
HX_LOCAL_STACK_FRAME(_hx_pos_fd8eaa6e8425d4a1_125_get_mockY,"starling.events.TouchMarker","get_mockY",0x3057d742,"starling.events.TouchMarker.get_mockY","starling/events/TouchMarker.hx",125,0x767a3d54)
namespace starling{
namespace events{

void TouchMarker_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_fd8eaa6e8425d4a1_44_new)
HXLINE(  45)		super::__construct();
HXLINE(  47)		this->_hx___center =  ::openfl::geom::Point_obj::__alloc( HX_CTX ,null(),null());
HXLINE(  48)		this->_hx___texture = this->createTexture();
HXLINE(  50)		{
HXLINE(  50)			int _g = (int)0;
HXDLIN(  50)			while((_g < (int)2)){
HXLINE(  50)				_g = (_g + (int)1);
HXDLIN(  50)				int i = (_g - (int)1);
HXLINE(  52)				 ::starling::display::Image marker =  ::starling::display::Image_obj::__alloc( HX_CTX ,this->_hx___texture);
HXLINE(  53)				marker->set_pivotX(((Float)this->_hx___texture->get_width() / (Float)(int)2));
HXLINE(  54)				marker->set_pivotY(((Float)this->_hx___texture->get_height() / (Float)(int)2));
HXLINE(  55)				marker->set_touchable(false);
HXLINE(  56)				this->addChild(marker);
            			}
            		}
            	}
...
void TouchMarker_obj::dispose(){
            	HX_STACKFRAME(&_hx_pos_fd8eaa6e8425d4a1_61_dispose)
HXLINE(  62)		this->_hx___texture->dispose();
...
bool withCenter = __o_withCenter.Default(false);
            	HX_STACKFRAME(&_hx_pos_fd8eaa6e8425d4a1_67_moveMarker)
HXLINE(  68)		if (withCenter) {
HXLINE(  70)			 ::openfl::geom::Point _hx_tmp = this->_hx___center;
HXDLIN(  70)			Float _hx_tmp1 = _hx_tmp->x;
HXDLIN(  70)			_hx_tmp->x = (_hx_tmp1 + (x - this->get_realMarker()->get_x()));
HXLINE(  71)			 ::openfl::geom::Point _hx_tmp2 = this->_hx___center;
HXDLIN(  71)			Float _hx_tmp3 = _hx_tmp2->y;
HXDLIN(  71)			_hx_tmp2->y = (_hx_tmp3 + (y - this->get_realMarker()->get_y()));
            		}
HXLINE(  74)		this->get_realMarker()->set_x(x);
HXLINE(  75)		this->get_realMarker()->set_y(y);
HXLINE(  76)		 ::starling::display::Image _hx_tmp4 = this->get_mockMarker();
HXDLIN(  76)		_hx_tmp4->set_x((((int)2 * this->_hx___center->x) - x));
HXLINE(  77)		 ::starling::display::Image _hx_tmp5 = this->get_mockMarker();
HXDLIN(  77)		_hx_tmp5->set_y((((int)2 * this->_hx___center->y) - y));
            	}
...
void TouchMarker_obj::moveCenter(Float x,Float y){
            	HX_STACKFRAME(&_hx_pos_fd8eaa6e8425d4a1_81_moveCenter)
HXLINE(  82)		this->_hx___center->x = x;
HXLINE(  83)		this->_hx___center->y = y;
HXLINE(  84)		Float _hx_tmp = this->get_realX();
HXDLIN(  84)		this->moveMarker(_hx_tmp,this->get_realY(),null());
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(TouchMarker_obj,moveCenter,(void))
 ...
 ::starling::textures::Texture TouchMarker_obj::createTexture(){
            	HX_GC_STACKFRAME(&_hx_pos_fd8eaa6e8425d4a1_88_createTexture)
HXLINE(  89)		Float scale = ::starling::core::Starling_obj::get_current()->get_contentScaleFactor();
HXLINE(  90)		Float radius = ((int)12 * scale);
HXLINE(  91)		int width = ::Std_obj::_hx_int(((int)32 * scale));
HXLINE(  92)		int height = ::Std_obj::_hx_int(((int)32 * scale));
HXLINE(  93)		Float thickness = (((Float)1.5) * scale);
HXLINE(  94)		 ::openfl::display::Shape shape =  ::openfl::display::Shape_obj::__alloc( HX_CTX );
HXLINE(  97)		shape->get_graphics()->lineStyle(thickness,(int)0,((Float)0.3),null(),null(),null(),null(),null());
HXLINE(  98)		 ::openfl::display::Graphics _hx_tmp = shape->get_graphics();
HXDLIN(  98)		_hx_tmp->drawCircle(((Float)width / (Float)(int)2),((Float)height / (Float)(int)2),(radius + thickness));
HXLINE( 101)		shape->get_graphics()->beginFill((int)16777215,((Float)0.4));
HXLINE( 102)		shape->get_graphics()->lineStyle(thickness,(int)16777215,null(),null(),null(),null(),null(),null());
HXLINE( 103)		 ::openfl::display::Graphics _hx_tmp1 = shape->get_graphics();
HXDLIN( 103)		_hx_tmp1->drawCircle(((Float)width / (Float)(int)2),((Float)height / (Float)(int)2),radius);
HXLINE( 104)		shape->get_graphics()->endFill();
HXLINE( 106)		 ::openfl::display::BitmapData bmpData =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,width,height,true,(int)0);
HXLINE( 107)		bmpData->draw(shape,null(),null(),null(),null(),null());
HXLINE( 109)		return ::starling::textures::Texture_obj::fromBitmapData(bmpData,false,false,scale,null(),null(),null());
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(TouchMarker_obj,createTexture,return )
 ...
 ::starling::display::Image TouchMarker_obj::get_realMarker(){
            	HX_STACKFRAME(&_hx_pos_fd8eaa6e8425d4a1_113_get_realMarker)
HXDLIN( 113)		return hx::TCast<  ::starling::display::Image >::cast(this->getChildAt((int)0));
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(TouchMarker_obj,get_realMarker,return )
 ...
 ::starling::display::Image TouchMarker_obj::get_mockMarker(){
            	HX_STACKFRAME(&_hx_pos_fd8eaa6e8425d4a1_115_get_mockMarker)
HXDLIN( 115)		return hx::TCast<  ::starling::display::Image >::cast(this->getChildAt((int)1));
            	}
...
Float TouchMarker_obj::get_realX(){
            	HX_STACKFRAME(&_hx_pos_fd8eaa6e8425d4a1_118_get_realX)
HXDLIN( 118)		return this->get_realMarker()->get_x();
            	}
...
Float TouchMarker_obj::get_realY(){
            	HX_STACKFRAME(&_hx_pos_fd8eaa6e8425d4a1_120_get_realY)
HXDLIN( 120)		return this->get_realMarker()->get_y();
            	}
...
Float TouchMarker_obj::get_mockX(){
            	HX_STACKFRAME(&_hx_pos_fd8eaa6e8425d4a1_123_get_mockX)
HXDLIN( 123)		return this->get_mockMarker()->get_x();
            	}
...
Float TouchMarker_obj::get_mockY(){
            	HX_STACKFRAME(&_hx_pos_fd8eaa6e8425d4a1_125_get_mockY)
HXDLIN( 125)		return this->get_mockMarker()->get_y();
            	}
