...
HX_DEFINE_STACK_FRAME(_hx_pos_a25101b6b1c78b1a_58_new,"starling.events.KeyboardEvent","new",0xb3996e16,"starling.events.KeyboardEvent.new","starling/events/KeyboardEvent.hx",58,0xb775183a)
HX_LOCAL_STACK_FRAME(_hx_pos_a25101b6b1c78b1a_74_preventDefault,"starling.events.KeyboardEvent","preventDefault",0x44d29ed3,"starling.events.KeyboardEvent.preventDefault","starling/events/KeyboardEvent.hx",74,0xb775183a)
HX_LOCAL_STACK_FRAME(_hx_pos_a25101b6b1c78b1a_78_isDefaultPrevented,"starling.events.KeyboardEvent","isDefaultPrevented",0xebf76f4a,"starling.events.KeyboardEvent.isDefaultPrevented","starling/events/KeyboardEvent.hx",78,0xb775183a)
HX_LOCAL_STACK_FRAME(_hx_pos_a25101b6b1c78b1a_84_get_charCode,"starling.events.KeyboardEvent","get_charCode",0xedce0eb6,"starling.events.KeyboardEvent.get_charCode","starling/events/KeyboardEvent.hx",84,0xb775183a)
HX_LOCAL_STACK_FRAME(_hx_pos_a25101b6b1c78b1a_88_get_keyCode,"starling.events.KeyboardEvent","get_keyCode",0x26e3c639,"starling.events.KeyboardEvent.get_keyCode","starling/events/KeyboardEvent.hx",88,0xb775183a)
HX_LOCAL_STACK_FRAME(_hx_pos_a25101b6b1c78b1a_93_get_keyLocation,"starling.events.KeyboardEvent","get_keyLocation",0x98e2f941,"starling.events.KeyboardEvent.get_keyLocation","starling/events/KeyboardEvent.hx",93,0xb775183a)
HX_LOCAL_STACK_FRAME(_hx_pos_a25101b6b1c78b1a_98_get_altKey,"starling.events.KeyboardEvent","get_altKey",0x3e873cc9,"starling.events.KeyboardEvent.get_altKey","starling/events/KeyboardEvent.hx",98,0xb775183a)
HX_LOCAL_STACK_FRAME(_hx_pos_a25101b6b1c78b1a_103_get_ctrlKey,"starling.events.KeyboardEvent","get_ctrlKey",0xecc2d981,"starling.events.KeyboardEvent.get_ctrlKey","starling/events/KeyboardEvent.hx",103,0xb775183a)
HX_LOCAL_STACK_FRAME(_hx_pos_a25101b6b1c78b1a_107_get_shiftKey,"starling.events.KeyboardEvent","get_shiftKey",0xeb4941d0,"starling.events.KeyboardEvent.get_shiftKey","starling/events/KeyboardEvent.hx",107,0xb775183a)
...
bool shiftKey = __o_shiftKey.Default(false);
            	HX_STACKFRAME(&_hx_pos_a25101b6b1c78b1a_58_new)
HXLINE(  59)		super::__construct(type,false,keyCode);
HXLINE(  60)		this->_hx___charCode = charCode;
HXLINE(  61)		this->_hx___keyCode = keyCode;
HXLINE(  62)		this->_hx___keyLocation = keyLocation;
HXLINE(  63)		this->_hx___ctrlKey = ctrlKey;
HXLINE(  64)		this->_hx___altKey = altKey;
HXLINE(  65)		this->_hx___shiftKey = shiftKey;
            	}
...
void KeyboardEvent_obj::preventDefault(){
            	HX_STACKFRAME(&_hx_pos_a25101b6b1c78b1a_74_preventDefault)
HXDLIN(  74)		this->_hx___isDefaultPrevented = true;
            	}
...
bool KeyboardEvent_obj::isDefaultPrevented(){
            	HX_STACKFRAME(&_hx_pos_a25101b6b1c78b1a_78_isDefaultPrevented)
HXDLIN(  78)		return this->_hx___isDefaultPrevented;
            	}
...
int KeyboardEvent_obj::get_charCode(){
            	HX_STACKFRAME(&_hx_pos_a25101b6b1c78b1a_84_get_charCode)
HXDLIN(  84)		return this->_hx___charCode;
            	}
...
int KeyboardEvent_obj::get_keyCode(){
            	HX_STACKFRAME(&_hx_pos_a25101b6b1c78b1a_88_get_keyCode)
HXDLIN(  88)		return this->_hx___keyCode;
            	}
...
int KeyboardEvent_obj::get_keyLocation(){
            	HX_STACKFRAME(&_hx_pos_a25101b6b1c78b1a_93_get_keyLocation)
HXDLIN(  93)		return this->_hx___keyLocation;
            	}
...
bool KeyboardEvent_obj::get_altKey(){
            	HX_STACKFRAME(&_hx_pos_a25101b6b1c78b1a_98_get_altKey)
HXDLIN(  98)		return this->_hx___altKey;
            	}
...
bool KeyboardEvent_obj::get_ctrlKey(){
            	HX_STACKFRAME(&_hx_pos_a25101b6b1c78b1a_103_get_ctrlKey)
HXDLIN( 103)		return this->_hx___ctrlKey;
            	}
...
bool KeyboardEvent_obj::get_shiftKey(){
            	HX_STACKFRAME(&_hx_pos_a25101b6b1c78b1a_107_get_shiftKey)
HXDLIN( 107)		return this->_hx___shiftKey;
            	}
