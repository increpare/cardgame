...
HX_DEFINE_STACK_FRAME(_hx_pos_784f0a97e19bf298_46_new,"starling.events.ResizeEvent","new",0xd6dfc0e9,"starling.events.ResizeEvent.new","starling/events/ResizeEvent.hx",46,0x33cb78c7)
HX_LOCAL_STACK_FRAME(_hx_pos_784f0a97e19bf298_51_get_width,"starling.events.ResizeEvent","get_width",0x3f288fa6,"starling.events.ResizeEvent.get_width","starling/events/ResizeEvent.hx",51,0x33cb78c7)
HX_LOCAL_STACK_FRAME(_hx_pos_784f0a97e19bf298_55_get_height,"starling.events.ResizeEvent","get_height",0xbaa49a47,"starling.events.ResizeEvent.get_height","starling/events/ResizeEvent.hx",55,0x33cb78c7)
...
bool bubbles = __o_bubbles.Default(false);
            	HX_GC_STACKFRAME(&_hx_pos_784f0a97e19bf298_46_new)
HXDLIN(  46)		super::__construct(type,bubbles, ::openfl::geom::Point_obj::__alloc( HX_CTX ,width,height));
            	}
...
int ResizeEvent_obj::get_width(){
            	HX_STACKFRAME(&_hx_pos_784f0a97e19bf298_51_get_width)
HXDLIN(  51)		return ::Std_obj::_hx_int(hx::TCast<  ::openfl::geom::Point >::cast(this->data)->x);
            	}
...
int ResizeEvent_obj::get_height(){
            	HX_STACKFRAME(&_hx_pos_784f0a97e19bf298_55_get_height)
HXDLIN(  55)		return ::Std_obj::_hx_int(hx::TCast<  ::openfl::geom::Point >::cast(this->data)->y);
            	}
