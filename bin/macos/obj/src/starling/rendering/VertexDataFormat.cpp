...
HX_LOCAL_STACK_FRAME(_hx_pos_962a7344827da2e7_127_extend,"starling.rendering.VertexDataFormat","extend",0xe92e253b,"starling.rendering.VertexDataFormat.extend","starling/rendering/VertexDataFormat.hx",127,0xf08f0fef)
HX_LOCAL_STACK_FRAME(_hx_pos_962a7344827da2e7_135_getSize,"starling.rendering.VertexDataFormat","getSize",0xcdabf1f6,"starling.rendering.VertexDataFormat.getSize","starling/rendering/VertexDataFormat.hx",135,0xf08f0fef)
HX_LOCAL_STACK_FRAME(_hx_pos_962a7344827da2e7_141_getSizeIn32Bits,"starling.rendering.VertexDataFormat","getSizeIn32Bits",0x7047f900,"starling.rendering.VertexDataFormat.getSizeIn32Bits","starling/rendering/VertexDataFormat.hx",141,0xf08f0fef)
HX_LOCAL_STACK_FRAME(_hx_pos_962a7344827da2e7_147_getOffset,"starling.rendering.VertexDataFormat","getOffset",0x25366008,"starling.rendering.VertexDataFormat.getOffset","starling/rendering/VertexDataFormat.hx",147,0xf08f0fef)
HX_LOCAL_STACK_FRAME(_hx_pos_962a7344827da2e7_153_getOffsetIn32Bits,"starling.rendering.VertexDataFormat","getOffsetIn32Bits",0xf1e9c912,"starling.rendering.VertexDataFormat.getOffsetIn32Bits","starling/rendering/VertexDataFormat.hx",153,0xf08f0fef)
HX_LOCAL_STACK_FRAME(_hx_pos_962a7344827da2e7_160_getFormat,"starling.rendering.VertexDataFormat","getFormat",0xc28557ac,"starling.rendering.VertexDataFormat.getFormat","starling/rendering/VertexDataFormat.hx",160,0xf08f0fef)
HX_LOCAL_STACK_FRAME(_hx_pos_962a7344827da2e7_166_getName,"starling.rendering.VertexDataFormat","getName",0xca57c380,"starling.rendering.VertexDataFormat.getName","starling/rendering/VertexDataFormat.hx",166,0xf08f0fef)
HX_LOCAL_STACK_FRAME(_hx_pos_962a7344827da2e7_171_hasAttribute,"starling.rendering.VertexDataFormat","hasAttribute",0x31b7e783,"starling.rendering.VertexDataFormat.hasAttribute","starling/rendering/VertexDataFormat.hx",171,0xf08f0fef)
HX_LOCAL_STACK_FRAME(_hx_pos_962a7344827da2e7_187_setVertexBufferAt,"starling.rendering.VertexDataFormat","setVertexBufferAt",0x02d96f18,"starling.rendering.VertexDataFormat.setVertexBufferAt","starling/rendering/VertexDataFormat.hx",187,0xf08f0fef)
HX_LOCAL_STACK_FRAME(_hx_pos_962a7344827da2e7_196_parseFormat,"starling.rendering.VertexDataFormat","parseFormat",0x596908c9,"starling.rendering.VertexDataFormat.parseFormat","starling/rendering/VertexDataFormat.hx",196,0xf08f0fef)
HX_LOCAL_STACK_FRAME(_hx_pos_962a7344827da2e7_239_toString,"starling.rendering.VertexDataFormat","toString",0x84867e4d,"starling.rendering.VertexDataFormat.toString","starling/rendering/VertexDataFormat.hx",239,0xf08f0fef)
HX_LOCAL_STACK_FRAME(_hx_pos_962a7344827da2e7_246_getAttribute,"starling.rendering.VertexDataFormat","getAttribute",0xb3bc9ec7,"starling.rendering.VertexDataFormat.getAttribute","starling/rendering/VertexDataFormat.hx",246,0xf08f0fef)
HX_LOCAL_STACK_FRAME(_hx_pos_962a7344827da2e7_263_get_attributes,"starling.rendering.VertexDataFormat","get_attributes",0x2cfe4d81,"starling.rendering.VertexDataFormat.get_attributes","starling/rendering/VertexDataFormat.hx",263,0xf08f0fef)
HX_LOCAL_STACK_FRAME(_hx_pos_962a7344827da2e7_272_get_formatString,"starling.rendering.VertexDataFormat","get_formatString",0xdbc39292,"starling.rendering.VertexDataFormat.get_formatString","starling/rendering/VertexDataFormat.hx",272,0xf08f0fef)
HX_LOCAL_STACK_FRAME(_hx_pos_962a7344827da2e7_279_get_vertexSize,"starling.rendering.VertexDataFormat","get_vertexSize",0x729cceef,"starling.rendering.VertexDataFormat.get_vertexSize","starling/rendering/VertexDataFormat.hx",279,0xf08f0fef)
HX_LOCAL_STACK_FRAME(_hx_pos_962a7344827da2e7_286_get_vertexSizeIn32Bits,"starling.rendering.VertexDataFormat","get_vertexSizeIn32Bits",0x2843f6f9,"starling.rendering.VertexDataFormat.get_vertexSizeIn32Bits","starling/rendering/VertexDataFormat.hx",286,0xf08f0fef)
HX_LOCAL_STACK_FRAME(_hx_pos_962a7344827da2e7_293_get_numAttributes,"starling.rendering.VertexDataFormat","get_numAttributes",0xb3598053,"starling.rendering.VertexDataFormat.get_numAttributes","starling/rendering/VertexDataFormat.hx",293,0xf08f0fef)
HX_LOCAL_STACK_FRAME(_hx_pos_962a7344827da2e7_105_fromString,"starling.rendering.VertexDataFormat","fromString",0x980b45bc,"starling.rendering.VertexDataFormat.fromString","starling/rendering/VertexDataFormat.hx",105,0xf08f0fef)
...
bool VertexDataFormat_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::starling::rendering::VertexDataFormat VertexDataFormat_obj::extend(::String format){
            	HX_STACKFRAME(&_hx_pos_962a7344827da2e7_127_extend)
HXDLIN( 127)		return ::starling::rendering::VertexDataFormat_obj::fromString(((this->_format + HX_(", ",74,26,00,00)) + format));
            	}
...
int VertexDataFormat_obj::getSize(::String attrName){
            	HX_STACKFRAME(&_hx_pos_962a7344827da2e7_135_getSize)
HXDLIN( 135)		return this->getAttribute(attrName)->size;
            	}
...
int VertexDataFormat_obj::getSizeIn32Bits(::String attrName){
            	HX_STACKFRAME(&_hx_pos_962a7344827da2e7_141_getSizeIn32Bits)
HXDLIN( 141)		return ::Std_obj::_hx_int(((Float)this->getAttribute(attrName)->size / (Float)(int)4));
            	}
...
int VertexDataFormat_obj::getOffset(::String attrName){
            	HX_STACKFRAME(&_hx_pos_962a7344827da2e7_147_getOffset)
HXDLIN( 147)		return this->getAttribute(attrName)->offset;
            	}
...
int VertexDataFormat_obj::getOffsetIn32Bits(::String attrName){
            	HX_STACKFRAME(&_hx_pos_962a7344827da2e7_153_getOffsetIn32Bits)
HXDLIN( 153)		return ::Std_obj::_hx_int(((Float)this->getAttribute(attrName)->offset / (Float)(int)4));
            	}
...
::String VertexDataFormat_obj::getFormat(::String attrName){
            	HX_STACKFRAME(&_hx_pos_962a7344827da2e7_160_getFormat)
HXDLIN( 160)		return this->getAttribute(attrName)->format;
            	}
...
::String VertexDataFormat_obj::getName(int attrIndex){
            	HX_STACKFRAME(&_hx_pos_962a7344827da2e7_166_getName)
HXDLIN( 166)		return ( ( ::starling::rendering::VertexDataAttribute)(::openfl::_Vector::IVector_obj::get(this->_attributes->data,attrIndex)) )->name;
            	}
...
bool VertexDataFormat_obj::hasAttribute(::String attrName){
            	HX_STACKFRAME(&_hx_pos_962a7344827da2e7_171_hasAttribute)
HXLINE( 172)		int numAttributes = ::openfl::_Vector::IVector_obj::get_length(this->_attributes->data);
HXLINE( 174)		{
HXLINE( 174)			int _g1 = (int)0;
HXDLIN( 174)			int _g = numAttributes;
HXDLIN( 174)			while((_g1 < _g)){
HXLINE( 174)				_g1 = (_g1 + (int)1);
HXDLIN( 174)				int i = (_g1 - (int)1);
HXLINE( 175)				if ((( ( ::starling::rendering::VertexDataAttribute)(::openfl::_Vector::IVector_obj::get(this->_attributes->data,i)) )->name == attrName)) {
...
void VertexDataFormat_obj::setVertexBufferAt(int index, ::openfl::display3D::VertexBuffer3D buffer,::String attrName){
            	HX_STACKFRAME(&_hx_pos_962a7344827da2e7_187_setVertexBufferAt)
HXLINE( 188)		 ::starling::rendering::VertexDataAttribute attribute = this->getAttribute(attrName);
HXLINE( 189)		 ::openfl::display3D::Context3D _hx_tmp = ::starling::core::Starling_obj::get_current()->get_context();
HXDLIN( 189)		int _hx_tmp1 = ::Std_obj::_hx_int(((Float)attribute->offset / (Float)(int)4));
HXDLIN( 189)		_hx_tmp->setVertexBufferAt(index,buffer,_hx_tmp1,::openfl::display3D::_Context3DVertexBufferFormat::Context3DVertexBufferFormat_Impl__obj::fromString(attribute->format));
            	}
...
void VertexDataFormat_obj::parseFormat(::String format){
            	HX_GC_STACKFRAME(&_hx_pos_962a7344827da2e7_196_parseFormat)
HXDLIN( 196)		bool _hx_tmp;
HXDLIN( 196)		if (hx::IsNotNull( format )) {
HXDLIN( 196)			_hx_tmp = (format != HX_("",00,00,00,00));
            		}
            		else {
HXDLIN( 196)			_hx_tmp = false;
            		}
HXDLIN( 196)		if (_hx_tmp) {
HXLINE( 198)			::openfl::_Vector::IVector_obj::set_length(this->_attributes->data,(int)0);
HXLINE( 199)			this->_format = HX_("",00,00,00,00);
HXLINE( 201)			::Array< ::String > parts = format.split(HX_(",",2c,00,00,00));
HXLINE( 202)			int numParts = parts->length;
HXLINE( 203)			int offset = (int)0;
HXLINE( 205)			{
HXLINE( 205)				int _g1 = (int)0;
HXDLIN( 205)				int _g = numParts;
HXDLIN( 205)				while((_g1 < _g)){
HXLINE( 205)					_g1 = (_g1 + (int)1);
HXDLIN( 205)					int i = (_g1 - (int)1);
HXLINE( 207)					::String attrDesc = parts->__get(i);
HXLINE( 208)					::Array< ::String > attrParts = attrDesc.split(HX_(":",3a,00,00,00));
HXLINE( 210)					if ((attrParts->length != (int)2)) {
HXLINE( 211)						HX_STACK_DO_THROW( ::openfl::errors::ArgumentError_obj::__alloc( HX_CTX ,(HX_("Missing colon: ",eb,da,48,f7) + attrDesc)));
            					}
HXLINE( 213)					::String attrName = ::starling::utils::StringUtil_obj::trim(attrParts->__get((int)0));
HXLINE( 214)					::String attrFormat = ::starling::utils::StringUtil_obj::trim(attrParts->__get((int)1));
HXLINE( 216)					bool _hx_tmp1;
HXDLIN( 216)					if ((attrName.length != (int)0)) {
HXLINE( 216)						_hx_tmp1 = (attrFormat.length == (int)0);
            					}
            					else {
HXLINE( 216)						_hx_tmp1 = true;
            					}
HXDLIN( 216)					if (_hx_tmp1) {
HXLINE( 217)						HX_STACK_DO_THROW( ::openfl::errors::ArgumentError_obj::__alloc( HX_CTX ,(HX_("Invalid format string: ",77,e8,04,57) + attrDesc)));
            					}
HXLINE( 219)					 ::starling::rendering::VertexDataAttribute attribute =  ::starling::rendering::VertexDataAttribute_obj::__alloc( HX_CTX ,attrName,attrFormat,offset);
HXLINE( 222)					offset = (offset + attribute->size);
HXLINE( 224)					 ::starling::rendering::VertexDataFormat _hx_tmp2 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 224)					::String _hx_tmp3;
HXDLIN( 224)					if ((i == (int)0)) {
HXLINE( 224)						_hx_tmp3 = HX_("",00,00,00,00);
            					}
            					else {
HXLINE( 224)						_hx_tmp3 = HX_(", ",74,26,00,00);
            					}
HXDLIN( 224)					_hx_tmp2->_format = (_hx_tmp2->_format + (((_hx_tmp3 + attribute->name) + HX_(":",3a,00,00,00)) + attribute->format));
HXLINE( 225)					{
HXLINE( 225)						 ::openfl::_Vector::AbstractVector this1 = this->_attributes;
HXDLIN( 225)						int index = ::openfl::_Vector::IVector_obj::get_length(this->_attributes->data);
HXDLIN( 225)						::openfl::_Vector::IVector_obj::set(this1->data,index,attribute);
            					}
            				}
            			}
HXLINE( 228)			this->_vertexSize = offset;
            		}
            		else {
HXLINE( 232)			this->_format = HX_("",00,00,00,00);
            		}
            	}
...
::String VertexDataFormat_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_962a7344827da2e7_239_toString)
HXDLIN( 239)		return this->_format;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(VertexDataFormat_obj,toString,return )
 ...
 ::starling::rendering::VertexDataAttribute VertexDataFormat_obj::getAttribute(::String attrName){
            	HX_STACKFRAME(&_hx_pos_962a7344827da2e7_246_getAttribute)
HXLINE( 247)		int i;
HXDLIN( 247)		 ::starling::rendering::VertexDataAttribute attribute;
HXLINE( 248)		int numAttributes = ::openfl::_Vector::IVector_obj::get_length(this->_attributes->data);
HXLINE( 250)		{
HXLINE( 250)			int _g1 = (int)0;
HXDLIN( 250)			int _g = numAttributes;
HXDLIN( 250)			while((_g1 < _g)){
HXLINE( 250)				_g1 = (_g1 + (int)1);
HXDLIN( 250)				int i1 = (_g1 - (int)1);
HXLINE( 252)				attribute = ( ( ::starling::rendering::VertexDataAttribute)(::openfl::_Vector::IVector_obj::get(this->_attributes->data,i1)) );
HXLINE( 253)				if ((attribute->name == attrName)) {
HXLINE( 253)					return attribute;
            				}
            			}
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(VertexDataFormat_obj,getAttribute,return )
 ...
 ::openfl::_Vector::AbstractVector VertexDataFormat_obj::get_attributes(){
            	HX_STACKFRAME(&_hx_pos_962a7344827da2e7_263_get_attributes)
HXDLIN( 263)		return this->_attributes;
            	}
...
::String VertexDataFormat_obj::get_formatString(){
            	HX_STACKFRAME(&_hx_pos_962a7344827da2e7_272_get_formatString)
HXDLIN( 272)		return this->_format;
            	}
...
int VertexDataFormat_obj::get_vertexSize(){
            	HX_STACKFRAME(&_hx_pos_962a7344827da2e7_279_get_vertexSize)
HXDLIN( 279)		return this->_vertexSize;
            	}
...
int VertexDataFormat_obj::get_vertexSizeIn32Bits(){
            	HX_STACKFRAME(&_hx_pos_962a7344827da2e7_286_get_vertexSizeIn32Bits)
HXDLIN( 286)		return ::Std_obj::_hx_int(((Float)this->_vertexSize / (Float)(int)4));
            	}
...
int VertexDataFormat_obj::get_numAttributes(){
            	HX_STACKFRAME(&_hx_pos_962a7344827da2e7_293_get_numAttributes)
HXDLIN( 293)		return ::openfl::_Vector::IVector_obj::get_length(this->_attributes->data);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(VertexDataFormat_obj,get_numAttributes,return )
 ...
 ::starling::rendering::VertexDataFormat VertexDataFormat_obj::fromString(::String format){
            	HX_GC_STACKFRAME(&_hx_pos_962a7344827da2e7_105_fromString)
HXDLIN( 105)		if (::starling::rendering::VertexDataFormat_obj::sFormats->exists(format)) {
HXDLIN( 105)			return ::starling::rendering::VertexDataFormat_obj::sFormats->get(format).StaticCast<  ::starling::rendering::VertexDataFormat >();
            		}
            		else {
HXLINE( 108)			 ::starling::rendering::VertexDataFormat instance =  ::starling::rendering::VertexDataFormat_obj::__alloc( HX_CTX );
HXLINE( 109)			instance->parseFormat(format);
HXLINE( 111)			::String normalizedFormat = instance->_format;
HXLINE( 113)			if (::starling::rendering::VertexDataFormat_obj::sFormats->exists(normalizedFormat)) {
HXLINE( 114)				instance = ::starling::rendering::VertexDataFormat_obj::sFormats->get(normalizedFormat).StaticCast<  ::starling::rendering::VertexDataFormat >();
            			}
HXLINE( 116)			::starling::rendering::VertexDataFormat_obj::sFormats->set(format,instance);
HXLINE( 117)			::starling::rendering::VertexDataFormat_obj::sFormats->set(normalizedFormat,instance);
HXLINE( 119)			return instance;
            		}
...
hx::Val VertexDataFormat_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
	...
	case 9:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"attributes") ) { if (inCallProp == hx::paccAlways) return hx::Val( get_attributes() ); }
	...
	case 12:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"numAttributes") ) { if (inCallProp == hx::paccAlways) return hx::Val( get_numAttributes() ); }
		break;
	case 14:
