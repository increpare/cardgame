...
HX_DEFINE_STACK_FRAME(_hx_pos_1cc5450ee560777f_58_new,"starling.rendering.MeshEffect","new",0x418257b8,"starling.rendering.MeshEffect.new","starling/rendering/MeshEffect.hx",58,0x04723a36)
HX_LOCAL_STACK_FRAME(_hx_pos_1cc5450ee560777f_73_get_programVariantName,"starling.rendering.MeshEffect","get_programVariantName",0xa2f3023d,"starling.rendering.MeshEffect.get_programVariantName","starling/rendering/MeshEffect.hx",73,0x04723a36)
HX_LOCAL_STACK_FRAME(_hx_pos_1cc5450ee560777f_80_createProgram,"starling.rendering.MeshEffect","createProgram",0x39ee4840,"starling.rendering.MeshEffect.createProgram","starling/rendering/MeshEffect.hx",80,0x04723a36)
HX_LOCAL_STACK_FRAME(_hx_pos_1cc5450ee560777f_124_beforeDraw,"starling.rendering.MeshEffect","beforeDraw",0x3530ebcb,"starling.rendering.MeshEffect.beforeDraw","starling/rendering/MeshEffect.hx",124,0x04723a36)
HX_LOCAL_STACK_FRAME(_hx_pos_1cc5450ee560777f_137_afterDraw,"starling.rendering.MeshEffect","afterDraw",0x36fd9598,"starling.rendering.MeshEffect.afterDraw","starling/rendering/MeshEffect.hx",137,0x04723a36)
HX_LOCAL_STACK_FRAME(_hx_pos_1cc5450ee560777f_145_get_vertexFormat,"starling.rendering.MeshEffect","get_vertexFormat",0x0ee02fec,"starling.rendering.MeshEffect.get_vertexFormat","starling/rendering/MeshEffect.hx",145,0x04723a36)
HX_LOCAL_STACK_FRAME(_hx_pos_1cc5450ee560777f_150_get_alpha,"starling.rendering.MeshEffect","get_alpha",0xd9ee9d0d,"starling.rendering.MeshEffect.get_alpha","starling/rendering/MeshEffect.hx",150,0x04723a36)
HX_LOCAL_STACK_FRAME(_hx_pos_1cc5450ee560777f_151_set_alpha,"starling.rendering.MeshEffect","set_alpha",0xbd3f8919,"starling.rendering.MeshEffect.set_alpha","starling/rendering/MeshEffect.hx",151,0x04723a36)
HX_LOCAL_STACK_FRAME(_hx_pos_1cc5450ee560777f_158_get_tinted,"starling.rendering.MeshEffect","get_tinted",0xb4259d8b,"starling.rendering.MeshEffect.get_tinted","starling/rendering/MeshEffect.hx",158,0x04723a36)
HX_LOCAL_STACK_FRAME(_hx_pos_1cc5450ee560777f_159_set_tinted,"starling.rendering.MeshEffect","set_tinted",0xb7a33bff,"starling.rendering.MeshEffect.set_tinted","starling/rendering/MeshEffect.hx",159,0x04723a36)
...
void MeshEffect_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_1cc5450ee560777f_58_new)
HXLINE(  59)		super::__construct();
HXLINE(  67)		this->_alpha = ((Float)1.0);
HXLINE(  68)		this->_optimizeIfNotTinted = hx::IsEq( ::Type_obj::getClass(hx::ObjectPtr<OBJ_>(this)),hx::ClassOf< ::starling::rendering::MeshEffect >() );
            	}
...
int MeshEffect_obj::get_programVariantName(){
            	HX_STACKFRAME(&_hx_pos_1cc5450ee560777f_73_get_programVariantName)
HXLINE(  74)		int noTinting;
HXDLIN(  74)		bool noTinting1;
HXDLIN(  74)		bool noTinting2;
HXDLIN(  74)		if (this->_optimizeIfNotTinted) {
HXLINE(  74)			noTinting2 = !(this->_tinted);
            		}
            		else {
HXLINE(  74)			noTinting2 = false;
            		}
HXDLIN(  74)		if (noTinting2) {
HXLINE(  74)			noTinting1 = (this->_alpha == ((Float)1.0));
            		}
            		else {
HXLINE(  74)			noTinting1 = false;
            		}
HXDLIN(  74)		if (noTinting1) {
HXLINE(  74)			noTinting = (int)1;
            		}
            		else {
HXLINE(  74)			noTinting = (int)0;
            		}
HXLINE(  75)		return ((int)this->super::get_programVariantName() | (int)((int)noTinting << (int)(int)3));
            	}


 ::starling::rendering::Program MeshEffect_obj::createProgram(){
            	HX_STACKFRAME(&_hx_pos_1cc5450ee560777f_80_createProgram)
HXLINE(  81)		::String vertexShader;
HXDLIN(  81)		::String fragmentShader;
HXLINE(  83)		if (hx::IsNotNull( this->get_texture() )) {
HXLINE(  85)			bool _hx_tmp;
HXDLIN(  85)			bool _hx_tmp1;
HXDLIN(  85)			if (this->_optimizeIfNotTinted) {
HXLINE(  85)				_hx_tmp1 = !(this->_tinted);
            			}
            			else {
HXLINE(  85)				_hx_tmp1 = false;
            			}
HXDLIN(  85)			if (_hx_tmp1) {
HXLINE(  85)				_hx_tmp = (this->_alpha == ((Float)1.0));
            			}
            			else {
HXLINE(  85)				_hx_tmp = false;
            			}
HXDLIN(  85)			if (_hx_tmp) {
HXLINE(  86)				return this->super::createProgram();
            			}
HXLINE(  88)			vertexShader = ((HX_("m44 op, va0, vc0 \n",bc,7d,9c,46) + HX_("mov v0, va1      \n",5e,f3,3b,47)) + HX_("mul v1, va2, vc4 \n",e1,20,d4,b3));
HXLINE(  93)			fragmentShader = (::starling::rendering::FilterEffect_obj::tex(HX_("ft0",22,cb,4d,00),HX_("v0",fa,66,00,00),(int)0,this->get_texture(),null()) + HX_("mul oc, ft0, v1  \n",3d,ed,71,10));
            		}
            		else {
HXLINE(  99)			vertexShader = (HX_("m44 op, va0, vc0 \n",bc,7d,9c,46) + HX_("mul v0, va2, vc4 \n",60,a3,13,6e));
HXLINE( 103)			fragmentShader = HX_("mov oc, v0       \n",38,ff,48,ad);
            		}
HXLINE( 107)		return ::starling::rendering::Program_obj::fromSource(vertexShader,fragmentShader,null());
            	}


void MeshEffect_obj::beforeDraw( ::openfl::display3D::Context3D context){
            	HX_STACKFRAME(&_hx_pos_1cc5450ee560777f_124_beforeDraw)
HXLINE( 125)		this->super::beforeDraw(context);
HXLINE( 127)		{
HXLINE( 127)			 ::openfl::_Vector::AbstractVector this1 = ::starling::rendering::MeshEffect_obj::sRenderAlpha;
HXDLIN( 127)			 ::openfl::_Vector::AbstractVector this2 = ::starling::rendering::MeshEffect_obj::sRenderAlpha;
HXDLIN( 127)			 ::openfl::_Vector::AbstractVector this3 = ::starling::rendering::MeshEffect_obj::sRenderAlpha;
HXDLIN( 127)			Float value = ( (Float)(::openfl::_Vector::IVector_obj::set(::starling::rendering::MeshEffect_obj::sRenderAlpha->data,(int)3,this->_alpha)) );
HXDLIN( 127)			Float value1 = ( (Float)(::openfl::_Vector::IVector_obj::set(this3->data,(int)2,value)) );
HXDLIN( 127)			Float value2 = ( (Float)(::openfl::_Vector::IVector_obj::set(this2->data,(int)1,value1)) );
HXDLIN( 127)			::openfl::_Vector::IVector_obj::set(this1->data,(int)0,value2);
            		}
HXLINE( 128)		context->setProgramConstantsFromVector((int)1,(int)4,::starling::rendering::MeshEffect_obj::sRenderAlpha,null());
HXLINE( 130)		bool _hx_tmp;
HXDLIN( 130)		bool _hx_tmp1;
HXDLIN( 130)		bool _hx_tmp2;
HXDLIN( 130)		if (!(this->_tinted)) {
HXLINE( 130)			_hx_tmp2 = (this->_alpha != ((Float)1.0));
            		}
            		else {
HXLINE( 130)			_hx_tmp2 = true;
            		}
HXDLIN( 130)		if (!(_hx_tmp2)) {
HXLINE( 130)			_hx_tmp1 = !(this->_optimizeIfNotTinted);
            		}
            		else {
HXLINE( 130)			_hx_tmp1 = true;
            		}
HXDLIN( 130)		if (!(_hx_tmp1)) {
HXLINE( 130)			_hx_tmp = hx::IsNull( this->get_texture() );
            		}
            		else {
HXLINE( 130)			_hx_tmp = true;
            		}
HXDLIN( 130)		if (_hx_tmp) {
HXLINE( 131)			 ::starling::rendering::VertexDataFormat _hx_tmp3 = this->get_vertexFormat();
HXDLIN( 131)			_hx_tmp3->setVertexBufferAt((int)2,this->get_vertexBuffer(),HX_("color",63,71,5c,4a));
            		}
            	}


void MeshEffect_obj::afterDraw( ::openfl::display3D::Context3D context){
            	HX_STACKFRAME(&_hx_pos_1cc5450ee560777f_137_afterDraw)
HXLINE( 138)		context->setVertexBufferAt((int)2,null(),null(),null());
HXLINE( 140)		this->super::afterDraw(context);
            	}


 ::starling::rendering::VertexDataFormat MeshEffect_obj::get_vertexFormat(){
            	HX_STACKFRAME(&_hx_pos_1cc5450ee560777f_145_get_vertexFormat)
HXDLIN( 145)		return ::starling::rendering::MeshEffect_obj::VERTEX_FORMAT;
            	}


Float MeshEffect_obj::get_alpha(){
            	HX_STACKFRAME(&_hx_pos_1cc5450ee560777f_150_get_alpha)
HXDLIN( 150)		return this->_alpha;
            	}
...
Float MeshEffect_obj::set_alpha(Float value){
            	HX_STACKFRAME(&_hx_pos_1cc5450ee560777f_151_set_alpha)
HXDLIN( 151)		return (this->_alpha = value);
            	}
...
bool MeshEffect_obj::get_tinted(){
            	HX_STACKFRAME(&_hx_pos_1cc5450ee560777f_158_get_tinted)
HXDLIN( 158)		return this->_tinted;
            	}
...
bool MeshEffect_obj::set_tinted(bool value){
            	HX_STACKFRAME(&_hx_pos_1cc5450ee560777f_159_set_tinted)
HXDLIN( 159)		return (this->_tinted = value);
            	}
