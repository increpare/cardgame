...
HX_DEFINE_STACK_FRAME(_hx_pos_8c43af1d6b0256b0_585_new,"starling.display.TextureSetupSettings","new",0x40860849,"starling.display.TextureSetupSettings.new","starling/display/Image.hx",585,0x1693cf77)
namespace starling{
namespace display{

void TextureSetupSettings_obj::__construct( ::Dynamic onAssign, ::Dynamic onRelease){
            	HX_STACKFRAME(&_hx_pos_8c43af1d6b0256b0_585_new)
HXLINE( 586)		this->onAssign = onAssign;
HXLINE( 587)		this->onRelease = onRelease;
            	}
