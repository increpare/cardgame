...
HX_DEFINE_STACK_FRAME(_hx_pos_482c99ec45249afd_55_new,"starling.animation.DelayedCall","new",0x57a0fca2,"starling.animation.DelayedCall.new","starling/animation/DelayedCall.hx",55,0x9af5c7d0)
HX_LOCAL_STACK_FRAME(_hx_pos_482c99ec45249afd_62_reset,"starling.animation.DelayedCall","reset",0x8cea8a91,"starling.animation.DelayedCall.reset","starling/animation/DelayedCall.hx",62,0x9af5c7d0)
HX_LOCAL_STACK_FRAME(_hx_pos_482c99ec45249afd_74_advanceTime,"starling.animation.DelayedCall","advanceTime",0x7833a7f1,"starling.animation.DelayedCall.advanceTime","starling/animation/DelayedCall.hx",74,0x9af5c7d0)
HX_LOCAL_STACK_FRAME(_hx_pos_482c99ec45249afd_108_complete,"starling.animation.DelayedCall","complete",0xa8c92537,"starling.animation.DelayedCall.complete","starling/animation/DelayedCall.hx",108,0x9af5c7d0)
HX_LOCAL_STACK_FRAME(_hx_pos_482c99ec45249afd_117_get_isComplete,"starling.animation.DelayedCall","get_isComplete",0x4c71320a,"starling.animation.DelayedCall.get_isComplete","starling/animation/DelayedCall.hx",117,0x9af5c7d0)
HX_LOCAL_STACK_FRAME(_hx_pos_482c99ec45249afd_122_get_totalTime,"starling.animation.DelayedCall","get_totalTime",0xf86f248a,"starling.animation.DelayedCall.get_totalTime","starling/animation/DelayedCall.hx",122,0x9af5c7d0)
HX_LOCAL_STACK_FRAME(_hx_pos_482c99ec45249afd_126_get_currentTime,"starling.animation.DelayedCall","get_currentTime",0xee6fe3bf,"starling.animation.DelayedCall.get_currentTime","starling/animation/DelayedCall.hx",126,0x9af5c7d0)
HX_LOCAL_STACK_FRAME(_hx_pos_482c99ec45249afd_131_get_repeatCount,"starling.animation.DelayedCall","get_repeatCount",0x846bd24d,"starling.animation.DelayedCall.get_repeatCount","starling/animation/DelayedCall.hx",131,0x9af5c7d0)
HX_LOCAL_STACK_FRAME(_hx_pos_482c99ec45249afd_132_set_repeatCount,"starling.animation.DelayedCall","set_repeatCount",0x80374f59,"starling.animation.DelayedCall.set_repeatCount","starling/animation/DelayedCall.hx",132,0x9af5c7d0)
HX_LOCAL_STACK_FRAME(_hx_pos_482c99ec45249afd_136_get_callback,"starling.animation.DelayedCall","get_callback",0x6b00894c,"starling.animation.DelayedCall.get_callback","starling/animation/DelayedCall.hx",136,0x9af5c7d0)
HX_LOCAL_STACK_FRAME(_hx_pos_482c99ec45249afd_141_get_arguments,"starling.animation.DelayedCall","get_arguments",0x7d4ee5ef,"starling.animation.DelayedCall.get_arguments","starling/animation/DelayedCall.hx",141,0x9af5c7d0)
HX_LOCAL_STACK_FRAME(_hx_pos_482c99ec45249afd_151_fromPool,"starling.animation.DelayedCall","fromPool",0xd12973e4,"starling.animation.DelayedCall.fromPool","starling/animation/DelayedCall.hx",151,0x9af5c7d0)
HX_LOCAL_STACK_FRAME(_hx_pos_482c99ec45249afd_157_toPool,"starling.animation.DelayedCall","toPool",0x37ec54f5,"starling.animation.DelayedCall.toPool","starling/animation/DelayedCall.hx",157,0x9af5c7d0)
HX_LOCAL_STACK_FRAME(_hx_pos_482c99ec45249afd_145_boot,"starling.animation.DelayedCall","boot",0x4d5511b0,"starling.animation.DelayedCall.boot","starling/animation/DelayedCall.hx",145,0x9af5c7d0)
namespace starling{
namespace animation{

void DelayedCall_obj::__construct( ::Dynamic callback,Float delay,::cpp::VirtualArray args){
            	HX_STACKFRAME(&_hx_pos_482c99ec45249afd_55_new)
HXLINE(  56)		super::__construct();
HXLINE(  57)		this->reset(callback,delay,args);
            	}
...
void *DelayedCall_obj::_hx_getInterface(int inHash) {
 ...
 ::starling::animation::DelayedCall DelayedCall_obj::reset( ::Dynamic callback,Float delay,::cpp::VirtualArray args){
            	HX_STACKFRAME(&_hx_pos_482c99ec45249afd_62_reset)
HXLINE(  63)		this->_hx___currentTime = (int)0;
HXLINE(  64)		this->_hx___totalTime = ::Math_obj::max(delay,((Float)0.0001));
HXLINE(  65)		this->_hx___callback = callback;
HXLINE(  66)		this->_hx___args = args;
HXLINE(  67)		this->_hx___repeatCount = (int)1;
...
void DelayedCall_obj::advanceTime(Float time){
            	HX_STACKFRAME(&_hx_pos_482c99ec45249afd_74_advanceTime)
HXLINE(  75)		Float previousTime = this->_hx___currentTime;
HXLINE(  76)		 ::starling::animation::DelayedCall _hx_tmp = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  76)		_hx_tmp->_hx___currentTime = (_hx_tmp->_hx___currentTime + time);
HXLINE(  78)		if ((this->_hx___currentTime > this->_hx___totalTime)) {
HXLINE(  79)			this->_hx___currentTime = this->_hx___totalTime;
            		}
HXLINE(  81)		bool _hx_tmp1;
HXDLIN(  81)		if ((previousTime < this->_hx___totalTime)) {
HXLINE(  81)			_hx_tmp1 = (this->_hx___currentTime >= this->_hx___totalTime);
            		}
            		else {
...
HXDLIN(  83)			if ((this->_hx___repeatCount != (int)0)) {
HXLINE(  83)				_hx_tmp2 = (this->_hx___repeatCount > (int)1);
            			}
            			else {
HXLINE(  83)				_hx_tmp2 = true;
            			}
HXDLIN(  83)			if (_hx_tmp2) {
HXLINE(  85)				::Reflect_obj::callMethod(this->_hx___callback,this->_hx___callback,this->_hx___args);
HXLINE(  87)				if ((this->_hx___repeatCount > (int)0)) {
HXLINE(  87)					 ::starling::animation::DelayedCall _hx_tmp3 = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  87)					_hx_tmp3->_hx___repeatCount = (_hx_tmp3->_hx___repeatCount - (int)1);
            				}
HXLINE(  88)				this->_hx___currentTime = (int)0;
HXLINE(  89)				this->advanceTime(((previousTime + time) - this->_hx___totalTime));
            			}
            			else {
HXLINE(  94)				 ::Dynamic call = this->_hx___callback;
HXLINE(  95)				::cpp::VirtualArray args = this->_hx___args;
HXLINE(  99)				this->dispatchEventWith(HX_("removeFro__juggler",4f,62,71,55),null(),null());
HXLINE( 100)				::Reflect_obj::callMethod(call,call,args);
            			}
            		}
            	}
...
void DelayedCall_obj::complete(){
            	HX_STACKFRAME(&_hx_pos_482c99ec45249afd_108_complete)
HXLINE( 109)		Float restTime = (this->_hx___totalTime - this->_hx___currentTime);
HXLINE( 110)		if ((restTime > (int)0)) {
HXLINE( 110)			this->advanceTime(restTime);
            		}
            	}
...
bool DelayedCall_obj::get_isComplete(){
            	HX_STACKFRAME(&_hx_pos_482c99ec45249afd_117_get_isComplete)
HXDLIN( 117)		if ((this->_hx___repeatCount == (int)1)) {
HXDLIN( 117)			return (this->_hx___currentTime >= this->_hx___totalTime);
            		}
            		else {
...
Float DelayedCall_obj::get_totalTime(){
            	HX_STACKFRAME(&_hx_pos_482c99ec45249afd_122_get_totalTime)
HXDLIN( 122)		return this->_hx___totalTime;
            	}
...
Float DelayedCall_obj::get_currentTime(){
            	HX_STACKFRAME(&_hx_pos_482c99ec45249afd_126_get_currentTime)
HXDLIN( 126)		return this->_hx___currentTime;
            	}
...
int DelayedCall_obj::get_repeatCount(){
            	HX_STACKFRAME(&_hx_pos_482c99ec45249afd_131_get_repeatCount)
HXDLIN( 131)		return this->_hx___repeatCount;
            	}
...
int DelayedCall_obj::set_repeatCount(int value){
            	HX_STACKFRAME(&_hx_pos_482c99ec45249afd_132_set_repeatCount)
HXDLIN( 132)		return (this->_hx___repeatCount = value);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(DelayedCall_obj,set_repeatCount,return )
 ...
 ::Dynamic DelayedCall_obj::get_callback(){
            	HX_STACKFRAME(&_hx_pos_482c99ec45249afd_136_get_callback)
HXDLIN( 136)		return this->_hx___callback;
            	}
...
::cpp::VirtualArray DelayedCall_obj::get_arguments(){
            	HX_STACKFRAME(&_hx_pos_482c99ec45249afd_141_get_arguments)
HXDLIN( 141)		return this->_hx___args;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(DelayedCall_obj,get_arguments,return )
 ...
 ::starling::animation::DelayedCall DelayedCall_obj::fromPool( ::Dynamic call,Float delay,::cpp::VirtualArray args){
            	HX_GC_STACKFRAME(&_hx_pos_482c99ec45249afd_151_fromPool)
HXDLIN( 151)		if ((::openfl::_Vector::IVector_obj::get_length(::starling::animation::DelayedCall_obj::sPool->data) != (int)0)) {
HXDLIN( 151)			return ( ( ::starling::animation::DelayedCall)(::openfl::_Vector::IVector_obj::pop(::starling::animation::DelayedCall_obj::sPool->data)) )->reset(call,delay,args);
            		}
            		else {
HXLINE( 152)			return  ::starling::animation::DelayedCall_obj::__alloc( HX_CTX ,call,delay,args);
            		}
...
void DelayedCall_obj::toPool( ::starling::animation::DelayedCall delayedCall){
            	HX_STACKFRAME(&_hx_pos_482c99ec45249afd_157_toPool)
HXLINE( 159)		delayedCall->_hx___callback = null();
HXLINE( 160)		delayedCall->_hx___args = null();
HXLINE( 161)		delayedCall->removeEventListeners(null());
HXLINE( 162)		::openfl::_Vector::IVector_obj::push(::starling::animation::DelayedCall_obj::sPool->data,delayedCall);
            	}
...
{
{
            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		 ::Dynamic _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_482c99ec45249afd_145_boot)
HXDLIN( 145)			int length = null();
HXDLIN( 145)			bool fixed = null();
HXDLIN( 145)			return  ::openfl::_Vector::AbstractVector_obj::__alloc( HX_CTX , ::openfl::_Vector::ObjectVector_obj::__alloc( HX_CTX ,length,fixed,null()),null());
            		}
            		HX_END_LOCAL_FUNC0(return)

            	HX_STACKFRAME(&_hx_pos_482c99ec45249afd_145_boot)
HXDLIN( 145)		sPool =  ::Dynamic(new _hx_Closure_0())();
            	}
}
