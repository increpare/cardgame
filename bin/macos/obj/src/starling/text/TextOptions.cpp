...
HX_DEFINE_STACK_FRAME(_hx_pos_3c21cd54e9f131bf_62_new,"starling.text.TextOptions","new",0x3e3e1728,"starling.text.TextOptions.new","starling/text/TextOptions.hx",62,0x3acb49a8)
HX_LOCAL_STACK_FRAME(_hx_pos_3c21cd54e9f131bf_75_copyFrom,"starling.text.TextOptions","copyFrom",0xccd92ff7,"starling.text.TextOptions.copyFrom","starling/text/TextOptions.hx",75,0x3acb49a8)
HX_LOCAL_STACK_FRAME(_hx_pos_3c21cd54e9f131bf_92_clone,"starling.text.TextOptions","clone",0x8a829c25,"starling.text.TextOptions.clone","starling/text/TextOptions.hx",92,0x3acb49a8)
HX_LOCAL_STACK_FRAME(_hx_pos_3c21cd54e9f131bf_102_get_wordWrap,"starling.text.TextOptions","get_wordWrap",0x01bf68f5,"starling.text.TextOptions.get_wordWrap","starling/text/TextOptions.hx",102,0x3acb49a8)
HX_LOCAL_STACK_FRAME(_hx_pos_3c21cd54e9f131bf_103_set_wordWrap,"starling.text.TextOptions","set_wordWrap",0x16b88c69,"starling.text.TextOptions.set_wordWrap","starling/text/TextOptions.hx",103,0x3acb49a8)
HX_LOCAL_STACK_FRAME(_hx_pos_3c21cd54e9f131bf_117_get_autoSize,"starling.text.TextOptions","get_autoSize",0x305de411,"starling.text.TextOptions.get_autoSize","starling/text/TextOptions.hx",117,0x3acb49a8)
HX_LOCAL_STACK_FRAME(_hx_pos_3c21cd54e9f131bf_118_set_autoSize,"starling.text.TextOptions","set_autoSize",0x45570785,"starling.text.TextOptions.set_autoSize","starling/text/TextOptions.hx",118,0x3acb49a8)
HX_LOCAL_STACK_FRAME(_hx_pos_3c21cd54e9f131bf_130_get_autoScale,"starling.text.TextOptions","get_autoScale",0x1dbf713a,"starling.text.TextOptions.get_autoScale","starling/text/TextOptions.hx",130,0x3acb49a8)
HX_LOCAL_STACK_FRAME(_hx_pos_3c21cd54e9f131bf_131_set_autoScale,"starling.text.TextOptions","set_autoScale",0x62c55346,"starling.text.TextOptions.set_autoScale","starling/text/TextOptions.hx",131,0x3acb49a8)
HX_LOCAL_STACK_FRAME(_hx_pos_3c21cd54e9f131bf_144_get_isHtmlText,"starling.text.TextOptions","get_isHtmlText",0xccb9d843,"starling.text.TextOptions.get_isHtmlText","starling/text/TextOptions.hx",144,0x3acb49a8)
HX_LOCAL_STACK_FRAME(_hx_pos_3c21cd54e9f131bf_145_set_isHtmlText,"starling.text.TextOptions","set_isHtmlText",0xecd9c0b7,"starling.text.TextOptions.set_isHtmlText","starling/text/TextOptions.hx",145,0x3acb49a8)
HX_LOCAL_STACK_FRAME(_hx_pos_3c21cd54e9f131bf_168_get_textureScale,"starling.text.TextOptions","get_textureScale",0xca188470,"starling.text.TextOptions.get_textureScale","starling/text/TextOptions.hx",168,0x3acb49a8)
HX_LOCAL_STACK_FRAME(_hx_pos_3c21cd54e9f131bf_169_set_textureScale,"starling.text.TextOptions","set_textureScale",0x205a71e4,"starling.text.TextOptions.set_textureScale","starling/text/TextOptions.hx",169,0x3acb49a8)
HX_LOCAL_STACK_FRAME(_hx_pos_3c21cd54e9f131bf_174_get_textureFormat,"starling.text.TextOptions","get_textureFormat",0xccc40291,"starling.text.TextOptions.get_textureFormat","starling/text/TextOptions.hx",174,0x3acb49a8)
HX_LOCAL_STACK_FRAME(_hx_pos_3c21cd54e9f131bf_175_set_textureFormat,"starling.text.TextOptions","set_textureFormat",0xf031da9d,"starling.text.TextOptions.set_textureFormat","starling/text/TextOptions.hx",175,0x3acb49a8)
HX_LOCAL_STACK_FRAME(_hx_pos_3c21cd54e9f131bf_188_get_padding,"starling.text.TextOptions","get_padding",0x5db208b0,"starling.text.TextOptions.get_padding","starling/text/TextOptions.hx",188,0x3acb49a8)
HX_LOCAL_STACK_FRAME(_hx_pos_3c21cd54e9f131bf_190_set_padding,"starling.text.TextOptions","set_padding",0x681f0fbc,"starling.text.TextOptions.set_padding","starling/text/TextOptions.hx",190,0x3acb49a8)
namespace starling{
namespace text{
...
bool autoScale = __o_autoScale.Default(false);
            	HX_STACKFRAME(&_hx_pos_3c21cd54e9f131bf_62_new)
HXLINE(  63)		super::__construct();
HXLINE(  64)		this->_hx___wordWrap = wordWrap;
HXLINE(  65)		this->_hx___autoScale = autoScale;
HXLINE(  66)		this->_hx___autoSize = HX_("none",b8,12,0a,49);
HXLINE(  67)		Float _hx_tmp;
HXDLIN(  67)		if (hx::IsNotNull( ::starling::core::Starling_obj::get_current() )) {
HXLINE(  67)			_hx_tmp = ::starling::core::Starling_obj::get_current()->get_contentScaleFactor();
            		}
            		else {
HXLINE(  67)			_hx_tmp = (int)1;
            		}
HXDLIN(  67)		this->_hx___textureScale = _hx_tmp;
HXLINE(  68)		this->_hx___textureFormat = ::starling::text::TextField_obj::get_defaultTextureFormat();
HXLINE(  69)		this->_hx___isHtmlText = false;
HXLINE(  70)		this->_hx___padding = ((Float)0.0);
            	}
...
void TextOptions_obj::copyFrom( ::starling::text::TextOptions options){
            	HX_STACKFRAME(&_hx_pos_3c21cd54e9f131bf_75_copyFrom)
HXLINE(  76)		this->_hx___wordWrap = options->_hx___wordWrap;
HXLINE(  77)		this->_hx___autoScale = options->_hx___autoScale;
HXLINE(  78)		this->_hx___autoSize = options->_hx___autoSize;
HXLINE(  79)		this->_hx___isHtmlText = options->_hx___isHtmlText;
HXLINE(  80)		this->_hx___textureScale = options->_hx___textureScale;
HXLINE(  81)		this->_hx___textureFormat = options->_hx___textureFormat;
HXLINE(  85)		this->_hx___padding = options->_hx___padding;
HXLINE(  87)		this->dispatchEventWith(HX_("change",70,91,72,b7),null(),null());
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(TextOptions_obj,copyFrom,(void))
 ...
 ::starling::text::TextOptions TextOptions_obj::clone(){
            	HX_STACKFRAME(&_hx_pos_3c21cd54e9f131bf_92_clone)
HXLINE(  93)		hx::Class actualClass = ::Type_obj::getClass(hx::ObjectPtr<OBJ_>(this));
HXLINE(  94)		 ::starling::text::TextOptions clone = ( ( ::starling::text::TextOptions)(::Type_obj::createInstance(actualClass,::cpp::VirtualArray_obj::__new(0))) );
HXLINE(  95)		clone->copyFrom(hx::ObjectPtr<OBJ_>(this));
HXLINE(  96)		return clone;
            	}
...
bool TextOptions_obj::get_wordWrap(){
            	HX_STACKFRAME(&_hx_pos_3c21cd54e9f131bf_102_get_wordWrap)
HXDLIN( 102)		return this->_hx___wordWrap;
            	}
...
bool TextOptions_obj::set_wordWrap(bool value){
            	HX_STACKFRAME(&_hx_pos_3c21cd54e9f131bf_103_set_wordWrap)
HXLINE( 104)		if ((this->_hx___wordWrap != value)) {
HXLINE( 106)			this->_hx___wordWrap = value;
HXLINE( 107)			this->dispatchEventWith(HX_("change",70,91,72,b7),null(),null());
            		}
...
::String TextOptions_obj::get_autoSize(){
            	HX_STACKFRAME(&_hx_pos_3c21cd54e9f131bf_117_get_autoSize)
HXDLIN( 117)		return this->_hx___autoSize;
            	}
...
::String TextOptions_obj::set_autoSize(::String value){
            	HX_STACKFRAME(&_hx_pos_3c21cd54e9f131bf_118_set_autoSize)
HXLINE( 119)		if ((this->_hx___autoSize != value)) {
HXLINE( 121)			this->_hx___autoSize = value;
HXLINE( 122)			this->dispatchEventWith(HX_("change",70,91,72,b7),null(),null());
            		}
...
bool TextOptions_obj::get_autoScale(){
            	HX_STACKFRAME(&_hx_pos_3c21cd54e9f131bf_130_get_autoScale)
HXDLIN( 130)		return this->_hx___autoScale;
            	}
...
bool TextOptions_obj::set_autoScale(bool value){
            	HX_STACKFRAME(&_hx_pos_3c21cd54e9f131bf_131_set_autoScale)
HXLINE( 132)		if ((this->_hx___autoScale != value)) {
HXLINE( 134)			this->_hx___autoScale = value;
HXLINE( 135)			this->dispatchEventWith(HX_("change",70,91,72,b7),null(),null());
            		}
...
bool TextOptions_obj::get_isHtmlText(){
            	HX_STACKFRAME(&_hx_pos_3c21cd54e9f131bf_144_get_isHtmlText)
HXDLIN( 144)		return this->_hx___isHtmlText;
            	}
...
bool TextOptions_obj::set_isHtmlText(bool value){
            	HX_STACKFRAME(&_hx_pos_3c21cd54e9f131bf_145_set_isHtmlText)
HXLINE( 146)		if ((this->_hx___isHtmlText != value)) {
HXLINE( 148)			this->_hx___isHtmlText = value;
HXLINE( 149)			this->dispatchEventWith(HX_("change",70,91,72,b7),null(),null());
            		}
...
Float TextOptions_obj::get_textureScale(){
            	HX_STACKFRAME(&_hx_pos_3c21cd54e9f131bf_168_get_textureScale)
HXDLIN( 168)		return this->_hx___textureScale;
            	}
...
Float TextOptions_obj::set_textureScale(Float value){
            	HX_STACKFRAME(&_hx_pos_3c21cd54e9f131bf_169_set_textureScale)
HXDLIN( 169)		return (this->_hx___textureScale = value);
            	}
...
::String TextOptions_obj::get_textureFormat(){
            	HX_STACKFRAME(&_hx_pos_3c21cd54e9f131bf_174_get_textureFormat)
HXDLIN( 174)		return this->_hx___textureFormat;
            	}
...
::String TextOptions_obj::set_textureFormat(::String value){
            	HX_STACKFRAME(&_hx_pos_3c21cd54e9f131bf_175_set_textureFormat)
HXLINE( 176)		if ((this->_hx___textureFormat != value)) {
HXLINE( 178)			this->_hx___textureFormat = value;
HXLINE( 179)			this->dispatchEventWith(HX_("change",70,91,72,b7),null(),null());
            		}
...
Float TextOptions_obj::get_padding(){
            	HX_STACKFRAME(&_hx_pos_3c21cd54e9f131bf_188_get_padding)
HXDLIN( 188)		return this->_hx___padding;
            	}
...
Float TextOptions_obj::set_padding(Float value){
            	HX_STACKFRAME(&_hx_pos_3c21cd54e9f131bf_190_set_padding)
HXLINE( 191)		if ((value < (int)0)) {
HXLINE( 191)			value = (int)0;
            		}
HXLINE( 192)		if ((this->_hx___padding != value)) {
HXLINE( 194)			this->_hx___padding = value;
HXLINE( 195)			this->dispatchEventWith(HX_("change",70,91,72,b7),null(),null());
            		}
