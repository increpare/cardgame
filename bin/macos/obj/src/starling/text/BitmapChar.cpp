...
HX_DEFINE_STACK_FRAME(_hx_pos_f2041bfce8b13bac_48_new,"starling.text.BitmapChar","new",0x0959b1f2,"starling.text.BitmapChar.new","starling/text/BitmapChar.hx",48,0x1a6cb95e)
HX_LOCAL_STACK_FRAME(_hx_pos_f2041bfce8b13bac_59_addKerning,"starling.text.BitmapChar","addKerning",0x5e6f3b59,"starling.text.BitmapChar.addKerning","starling/text/BitmapChar.hx",59,0x1a6cb95e)
HX_LOCAL_STACK_FRAME(_hx_pos_f2041bfce8b13bac_69_getKerning,"starling.text.BitmapChar","getKerning",0x46469584,"starling.text.BitmapChar.getKerning","starling/text/BitmapChar.hx",69,0x1a6cb95e)
HX_LOCAL_STACK_FRAME(_hx_pos_f2041bfce8b13bac_76_createImage,"starling.text.BitmapChar","createImage",0x77e11a51,"starling.text.BitmapChar.createImage","starling/text/BitmapChar.hx",76,0x1a6cb95e)
HX_LOCAL_STACK_FRAME(_hx_pos_f2041bfce8b13bac_81_get_charID,"starling.text.BitmapChar","get_charID",0xeeaa44a8,"starling.text.BitmapChar.get_charID","starling/text/BitmapChar.hx",81,0x1a6cb95e)
HX_LOCAL_STACK_FRAME(_hx_pos_f2041bfce8b13bac_85_get_xOffset,"starling.text.BitmapChar","get_xOffset",0x29dad9d4,"starling.text.BitmapChar.get_xOffset","starling/text/BitmapChar.hx",85,0x1a6cb95e)
HX_LOCAL_STACK_FRAME(_hx_pos_f2041bfce8b13bac_89_get_yOffset,"starling.text.BitmapChar","get_yOffset",0x53705095,"starling.text.BitmapChar.get_yOffset","starling/text/BitmapChar.hx",89,0x1a6cb95e)
HX_LOCAL_STACK_FRAME(_hx_pos_f2041bfce8b13bac_93_get_xAdvance,"starling.text.BitmapChar","get_xAdvance",0x8d4abf21,"starling.text.BitmapChar.get_xAdvance","starling/text/BitmapChar.hx",93,0x1a6cb95e)
HX_LOCAL_STACK_FRAME(_hx_pos_f2041bfce8b13bac_97_get_texture,"starling.text.BitmapChar","get_texture",0xb5d7ec84,"starling.text.BitmapChar.get_texture","starling/text/BitmapChar.hx",97,0x1a6cb95e)
HX_LOCAL_STACK_FRAME(_hx_pos_f2041bfce8b13bac_101_get_width,"starling.text.BitmapChar","get_width",0x3d6e6d6f,"starling.text.BitmapChar.get_width","starling/text/BitmapChar.hx",101,0x1a6cb95e)
HX_LOCAL_STACK_FRAME(_hx_pos_f2041bfce8b13bac_105_get_height,"starling.text.BitmapChar","get_height",0x3980cc5e,"starling.text.BitmapChar.get_height","starling/text/BitmapChar.hx",105,0x1a6cb95e)
namespace starling{
namespace text{

void BitmapChar_obj::__construct(int id, ::starling::textures::Texture texture,Float xOffset,Float yOffset,Float xAdvance){
            	HX_STACKFRAME(&_hx_pos_f2041bfce8b13bac_48_new)
HXLINE(  49)		this->_hx___charID = id;
HXLINE(  50)		this->_hx___texture = texture;
HXLINE(  51)		this->_hx___xOffset = xOffset;
HXLINE(  52)		this->_hx___yOffset = yOffset;
HXLINE(  53)		this->_hx___xAdvance = xAdvance;
HXLINE(  54)		this->_hx___kernings = null();
            	}
...
void BitmapChar_obj::addKerning(int charID,Float amount){
            	HX_GC_STACKFRAME(&_hx_pos_f2041bfce8b13bac_59_addKerning)
HXLINE(  60)		if (hx::IsNull( this->_hx___kernings )) {
HXLINE(  61)			this->_hx___kernings =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
            		}
HXLINE(  63)		this->_hx___kernings->set(charID,amount);
            	}
...
Float BitmapChar_obj::getKerning(int charID){
            	HX_STACKFRAME(&_hx_pos_f2041bfce8b13bac_69_getKerning)
HXDLIN(  69)		bool _hx_tmp;
HXDLIN(  69)		if (hx::IsNotNull( this->_hx___kernings )) {
HXDLIN(  69)			_hx_tmp = hx::IsNull( this->_hx___kernings->get(charID) );
            		}
            		else {
HXDLIN(  69)			_hx_tmp = true;
            		}
HXDLIN(  69)		if (_hx_tmp) {
HXDLIN(  69)			return ((Float)0.0);
            		}
            		else {
HXLINE(  70)			return ( (Float)(this->_hx___kernings->get(charID)) );
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(BitmapChar_obj,getKerning,return )
 ...
 ::starling::display::Image BitmapChar_obj::createImage(){
            	HX_GC_STACKFRAME(&_hx_pos_f2041bfce8b13bac_76_createImage)
HXDLIN(  76)		return  ::starling::display::Image_obj::__alloc( HX_CTX ,this->_hx___texture);
            	}
...
int BitmapChar_obj::get_charID(){
            	HX_STACKFRAME(&_hx_pos_f2041bfce8b13bac_81_get_charID)
HXDLIN(  81)		return this->_hx___charID;
            	}
...
Float BitmapChar_obj::get_xOffset(){
            	HX_STACKFRAME(&_hx_pos_f2041bfce8b13bac_85_get_xOffset)
HXDLIN(  85)		return this->_hx___xOffset;
            	}
...
Float BitmapChar_obj::get_yOffset(){
            	HX_STACKFRAME(&_hx_pos_f2041bfce8b13bac_89_get_yOffset)
HXDLIN(  89)		return this->_hx___yOffset;
            	}
...
Float BitmapChar_obj::get_xAdvance(){
            	HX_STACKFRAME(&_hx_pos_f2041bfce8b13bac_93_get_xAdvance)
HXDLIN(  93)		return this->_hx___xAdvance;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(BitmapChar_obj,get_xAdvance,return )
 ...
 ::starling::textures::Texture BitmapChar_obj::get_texture(){
            	HX_STACKFRAME(&_hx_pos_f2041bfce8b13bac_97_get_texture)
HXDLIN(  97)		return this->_hx___texture;
            	}
...
Float BitmapChar_obj::get_width(){
            	HX_STACKFRAME(&_hx_pos_f2041bfce8b13bac_101_get_width)
HXDLIN( 101)		return this->_hx___texture->get_width();
            	}
...
Float BitmapChar_obj::get_height(){
            	HX_STACKFRAME(&_hx_pos_f2041bfce8b13bac_105_get_height)
HXDLIN( 105)		return this->_hx___texture->get_height();
            	}
