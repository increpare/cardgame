...
HX_DEFINE_STACK_FRAME(_hx_pos_b9c3130cbc8a9f27_537_new,"starling.text.CharLocation","new",0x752a9a78,"starling.text.CharLocation.new","starling/text/BitmapFont.hx",537,0xe1349c05)
HX_LOCAL_STACK_FRAME(_hx_pos_b9c3130cbc8a9f27_541_reset,"starling.text.CharLocation","reset",0x5677c9e7,"starling.text.CharLocation.reset","starling/text/BitmapFont.hx",541,0xe1349c05)
HX_LOCAL_STACK_FRAME(_hx_pos_b9c3130cbc8a9f27_555_instanceFromPool,"starling.text.CharLocation","instanceFromPool",0xe8670f03,"starling.text.CharLocation.instanceFromPool","starling/text/BitmapFont.hx",555,0xe1349c05)
HX_LOCAL_STACK_FRAME(_hx_pos_b9c3130cbc8a9f27_566_vectorFromPool,"starling.text.CharLocation","vectorFromPool",0xc9a67431,"starling.text.CharLocation.vectorFromPool","starling/text/BitmapFont.hx",566,0xe1349c05)
HX_LOCAL_STACK_FRAME(_hx_pos_b9c3130cbc8a9f27_577_rechargePool,"starling.text.CharLocation","rechargePool",0xf3f5e5cb,"starling.text.CharLocation.rechargePool","starling/text/BitmapFont.hx",577,0xe1349c05)
HX_LOCAL_STACK_FRAME(_hx_pos_b9c3130cbc8a9f27_548_boot,"starling.text.CharLocation","boot",0x08358f1a,"starling.text.CharLocation.boot","starling/text/BitmapFont.hx",548,0xe1349c05)
HX_LOCAL_STACK_FRAME(_hx_pos_b9c3130cbc8a9f27_549_boot,"starling.text.CharLocation","boot",0x08358f1a,"starling.text.CharLocation.boot","starling/text/BitmapFont.hx",549,0xe1349c05)
HX_LOCAL_STACK_FRAME(_hx_pos_b9c3130cbc8a9f27_551_boot,"starling.text.CharLocation","boot",0x08358f1a,"starling.text.CharLocation.boot","starling/text/BitmapFont.hx",551,0xe1349c05)
HX_LOCAL_STACK_FRAME(_hx_pos_b9c3130cbc8a9f27_552_boot,"starling.text.CharLocation","boot",0x08358f1a,"starling.text.CharLocation.boot","starling/text/BitmapFont.hx",552,0xe1349c05)
namespace starling{
namespace text{

void CharLocation_obj::__construct( ::starling::text::BitmapChar _hx_char){
            	HX_STACKFRAME(&_hx_pos_b9c3130cbc8a9f27_537_new)
HXDLIN( 537)		this->reset(_hx_char);
            	}
...
bool CharLocation_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::starling::text::CharLocation CharLocation_obj::reset( ::starling::text::BitmapChar _hx_char){
            	HX_STACKFRAME(&_hx_pos_b9c3130cbc8a9f27_541_reset)
HXLINE( 542)		this->_hx_char = _hx_char;
HXLINE( 543)		return hx::ObjectPtr<OBJ_>(this);
            	}
...
::Array< ::Dynamic> CharLocation_obj::sVectorLoan;
 ...
 ::starling::text::CharLocation CharLocation_obj::instanceFromPool( ::starling::text::BitmapChar _hx_char){
            	HX_GC_STACKFRAME(&_hx_pos_b9c3130cbc8a9f27_555_instanceFromPool)
HXLINE( 556)		 ::starling::text::CharLocation instance;
HXDLIN( 556)		if ((::openfl::_Vector::IVector_obj::get_length(::starling::text::CharLocation_obj::sInstancePool->data) > (int)0)) {
HXLINE( 556)			instance = ( ( ::starling::text::CharLocation)(::openfl::_Vector::IVector_obj::pop(::starling::text::CharLocation_obj::sInstancePool->data)) );
            		}
            		else {
HXLINE( 556)			instance =  ::starling::text::CharLocation_obj::__alloc( HX_CTX ,_hx_char);
            		}
HXLINE( 559)		instance->reset(_hx_char);
HXLINE( 560)		{
HXLINE( 560)			 ::openfl::_Vector::AbstractVector this1 = ::starling::text::CharLocation_obj::sInstanceLoan;
HXDLIN( 560)			int index = ::openfl::_Vector::IVector_obj::get_length(::starling::text::CharLocation_obj::sInstanceLoan->data);
HXDLIN( 560)			::openfl::_Vector::IVector_obj::set(this1->data,index,instance);
            		}
HXLINE( 562)		return instance;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(CharLocation_obj,instanceFromPool,return )
 ...
 ::openfl::_Vector::AbstractVector CharLocation_obj::vectorFromPool(){
            	HX_GC_STACKFRAME(&_hx_pos_b9c3130cbc8a9f27_566_vectorFromPool)
HXLINE( 567)		 ::openfl::_Vector::AbstractVector vector;
HXDLIN( 567)		if ((::starling::text::CharLocation_obj::sVectorPool->length > (int)0)) {
HXLINE( 567)			vector = ::starling::text::CharLocation_obj::sVectorPool->pop().StaticCast<  ::openfl::_Vector::AbstractVector >();
            		}
            		else {
HXLINE( 568)			int length = null();
HXDLIN( 568)			bool fixed = null();
HXLINE( 567)			vector =  ::openfl::_Vector::AbstractVector_obj::__alloc( HX_CTX , ::openfl::_Vector::ObjectVector_obj::__alloc( HX_CTX ,length,fixed,null()),null());
            		}
HXLINE( 570)		::openfl::_Vector::IVector_obj::set_length(vector->data,(int)0);
HXLINE( 571)		::starling::text::CharLocation_obj::sVectorLoan[::starling::text::CharLocation_obj::sVectorLoan->length] = vector;
HXLINE( 573)		return vector;
            	}
...
void CharLocation_obj::rechargePool(){
            	HX_STACKFRAME(&_hx_pos_b9c3130cbc8a9f27_577_rechargePool)
HXLINE( 578)		 ::starling::text::CharLocation instance;
HXLINE( 579)		 ::openfl::_Vector::AbstractVector vector;
HXLINE( 581)		while((::openfl::_Vector::IVector_obj::get_length(::starling::text::CharLocation_obj::sInstanceLoan->data) > (int)0)){
HXLINE( 583)			instance = ( ( ::starling::text::CharLocation)(::openfl::_Vector::IVector_obj::pop(::starling::text::CharLocation_obj::sInstanceLoan->data)) );
HXLINE( 584)			instance->_hx_char = null();
HXLINE( 585)			{
HXLINE( 585)				 ::openfl::_Vector::AbstractVector this1 = ::starling::text::CharLocation_obj::sInstancePool;
HXDLIN( 585)				int index = ::openfl::_Vector::IVector_obj::get_length(::starling::text::CharLocation_obj::sInstancePool->data);
HXDLIN( 585)				::openfl::_Vector::IVector_obj::set(this1->data,index,instance);
            			}
            		}
HXLINE( 588)		while((::starling::text::CharLocation_obj::sVectorLoan->length > (int)0)){
HXLINE( 590)			vector = ::starling::text::CharLocation_obj::sVectorLoan->pop().StaticCast<  ::openfl::_Vector::AbstractVector >();
HXLINE( 591)			::openfl::_Vector::IVector_obj::set_length(vector->data,(int)0);
HXLINE( 592)			::starling::text::CharLocation_obj::sVectorPool[::starling::text::CharLocation_obj::sVectorPool->length] = vector;
            		}
            	}
...
{
{
            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		 ::Dynamic _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_b9c3130cbc8a9f27_548_boot)
HXDLIN( 548)			int length = null();
HXDLIN( 548)			bool fixed = null();
HXDLIN( 548)			return  ::openfl::_Vector::AbstractVector_obj::__alloc( HX_CTX , ::openfl::_Vector::ObjectVector_obj::__alloc( HX_CTX ,length,fixed,null()),null());
            		}
            		HX_END_LOCAL_FUNC0(return)

            	HX_STACKFRAME(&_hx_pos_b9c3130cbc8a9f27_548_boot)
HXDLIN( 548)		sInstancePool =  ::Dynamic(new _hx_Closure_0())();
            	}
{
            	HX_STACKFRAME(&_hx_pos_b9c3130cbc8a9f27_549_boot)
HXDLIN( 549)		sVectorPool = ::Array_obj< ::Dynamic>::__new(0);
            	}
{
            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		 ::Dynamic _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_b9c3130cbc8a9f27_551_boot)
HXDLIN( 551)			int length = null();
HXDLIN( 551)			bool fixed = null();
HXDLIN( 551)			return  ::openfl::_Vector::AbstractVector_obj::__alloc( HX_CTX , ::openfl::_Vector::ObjectVector_obj::__alloc( HX_CTX ,length,fixed,null()),null());
            		}
            		HX_END_LOCAL_FUNC0(return)

            	HX_STACKFRAME(&_hx_pos_b9c3130cbc8a9f27_551_boot)
HXDLIN( 551)		sInstanceLoan =  ::Dynamic(new _hx_Closure_0())();
            	}
{
            	HX_STACKFRAME(&_hx_pos_b9c3130cbc8a9f27_552_boot)
HXDLIN( 552)		sVectorLoan = ::Array_obj< ::Dynamic>::__new(0);
            	}
}
