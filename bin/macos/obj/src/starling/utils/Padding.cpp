...
HX_DEFINE_STACK_FRAME(_hx_pos_24c202be9f4ff34a_43_new,"starling.utils.Padding","new",0x33d0bc40,"starling.utils.Padding.new","starling/utils/Padding.hx",43,0xdbdfc872)
HX_LOCAL_STACK_FRAME(_hx_pos_24c202be9f4ff34a_50_setTo,"starling.utils.Padding","setTo",0x37a7359d,"starling.utils.Padding.setTo","starling/utils/Padding.hx",50,0xdbdfc872)
HX_LOCAL_STACK_FRAME(_hx_pos_24c202be9f4ff34a_64_setToUniform,"starling.utils.Padding","setToUniform",0x237ed117,"starling.utils.Padding.setToUniform","starling/utils/Padding.hx",64,0xdbdfc872)
HX_LOCAL_STACK_FRAME(_hx_pos_24c202be9f4ff34a_70_setToSymmetric,"starling.utils.Padding","setToSymmetric",0x9f18c31a,"starling.utils.Padding.setToSymmetric","starling/utils/Padding.hx",70,0xdbdfc872)
HX_LOCAL_STACK_FRAME(_hx_pos_24c202be9f4ff34a_77_copyFrom,"starling.utils.Padding","copyFrom",0xe12113df,"starling.utils.Padding.copyFrom","starling/utils/Padding.hx",77,0xdbdfc872)
HX_LOCAL_STACK_FRAME(_hx_pos_24c202be9f4ff34a_84_clone,"starling.utils.Padding","clone",0x05dab73d,"starling.utils.Padding.clone","starling/utils/Padding.hx",84,0xdbdfc872)
HX_LOCAL_STACK_FRAME(_hx_pos_24c202be9f4ff34a_89_get_left,"starling.utils.Padding","get_left",0xe02acbb0,"starling.utils.Padding.get_left","starling/utils/Padding.hx",89,0xdbdfc872)
HX_LOCAL_STACK_FRAME(_hx_pos_24c202be9f4ff34a_91_set_left,"starling.utils.Padding","set_left",0x8e882524,"starling.utils.Padding.set_left","starling/utils/Padding.hx",91,0xdbdfc872)
HX_LOCAL_STACK_FRAME(_hx_pos_24c202be9f4ff34a_102_get_right,"starling.utils.Padding","get_right",0xbc547c13,"starling.utils.Padding.get_right","starling/utils/Padding.hx",102,0xdbdfc872)
HX_LOCAL_STACK_FRAME(_hx_pos_24c202be9f4ff34a_104_set_right,"starling.utils.Padding","set_right",0x9fa5681f,"starling.utils.Padding.set_right","starling/utils/Padding.hx",104,0xdbdfc872)
HX_LOCAL_STACK_FRAME(_hx_pos_24c202be9f4ff34a_115_get_top,"starling.utils.Padding","get_top",0xec5d8b0c,"starling.utils.Padding.get_top","starling/utils/Padding.hx",115,0xdbdfc872)
HX_LOCAL_STACK_FRAME(_hx_pos_24c202be9f4ff34a_117_set_top,"starling.utils.Padding","set_top",0xdf5f1c18,"starling.utils.Padding.set_top","starling/utils/Padding.hx",117,0xdbdfc872)
HX_LOCAL_STACK_FRAME(_hx_pos_24c202be9f4ff34a_128_get_bottom,"starling.utils.Padding","get_bottom",0x24eaa6d4,"starling.utils.Padding.get_bottom","starling/utils/Padding.hx",128,0xdbdfc872)
HX_LOCAL_STACK_FRAME(_hx_pos_24c202be9f4ff34a_130_set_bottom,"starling.utils.Padding","set_bottom",0x28684548,"starling.utils.Padding.set_bottom","starling/utils/Padding.hx",130,0xdbdfc872)
namespace starling{
namespace utils{
...
Float bottom = __o_bottom.Default(0);
            	HX_STACKFRAME(&_hx_pos_24c202be9f4ff34a_43_new)
HXLINE(  44)		super::__construct();
HXLINE(  45)		this->setTo(left,right,top,bottom);
            	}
...
Float top = __o_top.Default(0);
Float bottom = __o_bottom.Default(0);
            	HX_STACKFRAME(&_hx_pos_24c202be9f4ff34a_50_setTo)
HXLINE(  51)		bool changed;
HXDLIN(  51)		bool changed1;
HXDLIN(  51)		bool changed2;
HXDLIN(  51)		if ((this->_left == left)) {
HXLINE(  51)			changed2 = (this->_right != right);
            		}
            		else {
HXLINE(  51)			changed2 = true;
            		}
HXDLIN(  51)		if (!(changed2)) {
HXLINE(  51)			changed1 = (this->_top != top);
            		}
            		else {
HXLINE(  51)			changed1 = true;
            		}
HXDLIN(  51)		if (!(changed1)) {
HXLINE(  51)			changed = (this->_bottom != bottom);
            		}
            		else {
HXLINE(  51)			changed = true;
            		}
HXLINE(  53)		this->_left = left;
HXLINE(  54)		this->_right = right;
HXLINE(  55)		this->_top = top;
HXLINE(  56)		this->_bottom = bottom;
HXLINE(  58)		if (changed) {
HXLINE(  58)			this->dispatchEventWith(HX_("change",70,91,72,b7),null(),null());
            		}
            	}
...
void Padding_obj::setToUniform(Float value){
            	HX_STACKFRAME(&_hx_pos_24c202be9f4ff34a_64_setToUniform)
HXDLIN(  64)		this->setTo(value,value,value,value);
            	}
...
void Padding_obj::setToSymmetric(Float horizontal,Float vertical){
            	HX_STACKFRAME(&_hx_pos_24c202be9f4ff34a_70_setToSymmetric)
HXDLIN(  70)		this->setTo(horizontal,horizontal,vertical,vertical);
            	}
...
void Padding_obj::copyFrom( ::starling::utils::Padding padding){
            	HX_STACKFRAME(&_hx_pos_24c202be9f4ff34a_77_copyFrom)
HXDLIN(  77)		if (hx::IsNull( padding )) {
HXDLIN(  77)			this->setTo((int)0,(int)0,(int)0,(int)0);
            		}
            		else {
HXLINE(  78)			this->setTo(padding->_left,padding->_right,padding->_top,padding->_bottom);
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Padding_obj,copyFrom,(void))
 ...
 ::starling::utils::Padding Padding_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_24c202be9f4ff34a_84_clone)
HXDLIN(  84)		return  ::starling::utils::Padding_obj::__alloc( HX_CTX ,this->_left,this->_right,this->_top,this->_bottom);
            	}
...
Float Padding_obj::get_left(){
            	HX_STACKFRAME(&_hx_pos_24c202be9f4ff34a_89_get_left)
HXDLIN(  89)		return this->_left;
            	}
...
Float Padding_obj::set_left(Float value){
            	HX_STACKFRAME(&_hx_pos_24c202be9f4ff34a_91_set_left)
HXLINE(  92)		if ((this->_left != value)) {
HXLINE(  94)			this->_left = value;
...
Float Padding_obj::get_right(){
            	HX_STACKFRAME(&_hx_pos_24c202be9f4ff34a_102_get_right)
HXDLIN( 102)		return this->_right;
            	}
...
Float Padding_obj::set_right(Float value){
            	HX_STACKFRAME(&_hx_pos_24c202be9f4ff34a_104_set_right)
HXLINE( 105)		if ((this->_right != value)) {
HXLINE( 107)			this->_right = value;
...
Float Padding_obj::get_top(){
            	HX_STACKFRAME(&_hx_pos_24c202be9f4ff34a_115_get_top)
HXDLIN( 115)		return this->_top;
            	}
...
Float Padding_obj::set_top(Float value){
            	HX_STACKFRAME(&_hx_pos_24c202be9f4ff34a_117_set_top)
HXLINE( 118)		if ((this->_top != value)) {
HXLINE( 120)			this->_top = value;
...
Float Padding_obj::get_bottom(){
            	HX_STACKFRAME(&_hx_pos_24c202be9f4ff34a_128_get_bottom)
HXDLIN( 128)		return this->_bottom;
            	}
...
Float Padding_obj::set_bottom(Float value){
            	HX_STACKFRAME(&_hx_pos_24c202be9f4ff34a_130_set_bottom)
HXLINE( 131)		if ((this->_bottom != value)) {
HXLINE( 133)			this->_bottom = value;
HXLINE( 134)			this->dispatchEventWith(HX_("change",70,91,72,b7),null(),null());
            		}
