...
HX_DEFINE_STACK_FRAME(_hx_pos_2264be4ccebe9e60_66_new,"starling.textures.SubTexture","new",0x13e2ac9d,"starling.textures.SubTexture.new","starling/textures/SubTexture.hx",66,0xcf04b193)
HX_LOCAL_STACK_FRAME(_hx_pos_2264be4ccebe9e60_81_setTo,"starling.textures.SubTexture","setTo",0xb45bb73a,"starling.textures.SubTexture.setTo","starling/textures/SubTexture.hx",81,0xcf04b193)
HX_LOCAL_STACK_FRAME(_hx_pos_2264be4ccebe9e60_110_updateMatrices,"starling.textures.SubTexture","updateMatrices",0x641127a6,"starling.textures.SubTexture.updateMatrices","starling/textures/SubTexture.hx",110,0xcf04b193)
HX_LOCAL_STACK_FRAME(_hx_pos_2264be4ccebe9e60_138_dispose,"starling.textures.SubTexture","dispose",0xf4eabf5c,"starling.textures.SubTexture.dispose","starling/textures/SubTexture.hx",138,0xcf04b193)
HX_LOCAL_STACK_FRAME(_hx_pos_2264be4ccebe9e60_145_get_parent,"starling.textures.SubTexture","get_parent",0x734f4a56,"starling.textures.SubTexture.get_parent","starling/textures/SubTexture.hx",145,0xcf04b193)
HX_LOCAL_STACK_FRAME(_hx_pos_2264be4ccebe9e60_149_get_ownsParent,"starling.textures.SubTexture","get_ownsParent",0x105eefa3,"starling.textures.SubTexture.get_ownsParent","starling/textures/SubTexture.hx",149,0xcf04b193)
HX_LOCAL_STACK_FRAME(_hx_pos_2264be4ccebe9e60_153_get_rotated,"starling.textures.SubTexture","get_rotated",0x82688afd,"starling.textures.SubTexture.get_rotated","starling/textures/SubTexture.hx",153,0xcf04b193)
HX_LOCAL_STACK_FRAME(_hx_pos_2264be4ccebe9e60_159_get_region,"starling.textures.SubTexture","get_region",0x865e0620,"starling.textures.SubTexture.get_region","starling/textures/SubTexture.hx",159,0xcf04b193)
HX_LOCAL_STACK_FRAME(_hx_pos_2264be4ccebe9e60_162_get_transformationMatrix,"starling.textures.SubTexture","get_transformationMatrix",0x65b1df16,"starling.textures.SubTexture.get_transformationMatrix","starling/textures/SubTexture.hx",162,0xcf04b193)
HX_LOCAL_STACK_FRAME(_hx_pos_2264be4ccebe9e60_165_get_transformationMatrixToRoot,"starling.textures.SubTexture","get_transformationMatrixToRoot",0xbbb820f3,"starling.textures.SubTexture.get_transformationMatrixToRoot","starling/textures/SubTexture.hx",165,0xcf04b193)
HX_LOCAL_STACK_FRAME(_hx_pos_2264be4ccebe9e60_168_get_base,"starling.textures.SubTexture","get_base",0xf1a44a3d,"starling.textures.SubTexture.get_base","starling/textures/SubTexture.hx",168,0xcf04b193)
HX_LOCAL_STACK_FRAME(_hx_pos_2264be4ccebe9e60_171_get_root,"starling.textures.SubTexture","get_root",0xfc42504e,"starling.textures.SubTexture.get_root","starling/textures/SubTexture.hx",171,0xcf04b193)
HX_LOCAL_STACK_FRAME(_hx_pos_2264be4ccebe9e60_174_get_format,"starling.textures.SubTexture","get_format",0x835fd463,"starling.textures.SubTexture.get_format","starling/textures/SubTexture.hx",174,0xcf04b193)
HX_LOCAL_STACK_FRAME(_hx_pos_2264be4ccebe9e60_177_get_width,"starling.textures.SubTexture","get_width",0x9ac53a5a,"starling.textures.SubTexture.get_width","starling/textures/SubTexture.hx",177,0xcf04b193)
HX_LOCAL_STACK_FRAME(_hx_pos_2264be4ccebe9e60_180_get_height,"starling.textures.SubTexture","get_height",0x881d4d13,"starling.textures.SubTexture.get_height","starling/textures/SubTexture.hx",180,0xcf04b193)
HX_LOCAL_STACK_FRAME(_hx_pos_2264be4ccebe9e60_183_get_nativeWidth,"starling.textures.SubTexture","get_nativeWidth",0x2d86b443,"starling.textures.SubTexture.get_nativeWidth","starling/textures/SubTexture.hx",183,0xcf04b193)
HX_LOCAL_STACK_FRAME(_hx_pos_2264be4ccebe9e60_186_get_nativeHeight,"starling.textures.SubTexture","get_nativeHeight",0x5ea67f0a,"starling.textures.SubTexture.get_nativeHeight","starling/textures/SubTexture.hx",186,0xcf04b193)
HX_LOCAL_STACK_FRAME(_hx_pos_2264be4ccebe9e60_189_get_mipMapping,"starling.textures.SubTexture","get_mipMapping",0xba8ff706,"starling.textures.SubTexture.get_mipMapping","starling/textures/SubTexture.hx",189,0xcf04b193)
HX_LOCAL_STACK_FRAME(_hx_pos_2264be4ccebe9e60_192_get_premultipliedAlpha,"starling.textures.SubTexture","get_premultipliedAlpha",0x7496e554,"starling.textures.SubTexture.get_premultipliedAlpha","starling/textures/SubTexture.hx",192,0xcf04b193)
HX_LOCAL_STACK_FRAME(_hx_pos_2264be4ccebe9e60_195_get_scale,"starling.textures.SubTexture","get_scale",0x493152de,"starling.textures.SubTexture.get_scale","starling/textures/SubTexture.hx",195,0xcf04b193)
HX_LOCAL_STACK_FRAME(_hx_pos_2264be4ccebe9e60_198_get_frame,"starling.textures.SubTexture","get_frame",0xd6e5fc81,"starling.textures.SubTexture.get_frame","starling/textures/SubTexture.hx",198,0xcf04b193)
namespace starling{
namespace textures{
...
Float scaleModifier = __o_scaleModifier.Default(1);
            	HX_STACKFRAME(&_hx_pos_2264be4ccebe9e60_66_new)
HXLINE(  67)		super::__construct();
HXLINE(  68)		this->setTo(parent,region,ownsParent,frame,rotated,scaleModifier);
            	}
...
bool rotated = __o_rotated.Default(false);
Float scaleModifier = __o_scaleModifier.Default(1);
            	HX_GC_STACKFRAME(&_hx_pos_2264be4ccebe9e60_81_setTo)
HXLINE(  82)		if (hx::IsNull( this->_region )) {
HXLINE(  82)			this->_region =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
            		}
HXLINE(  83)		if (hx::IsNotNull( region )) {
HXLINE(  83)			this->_region->copyFrom(region);
            		}
            		else {
HXLINE(  84)			 ::openfl::geom::Rectangle _hx_tmp = this->_region;
HXDLIN(  84)			Float _hx_tmp1 = parent->get_width();
HXDLIN(  84)			_hx_tmp->setTo((int)0,(int)0,_hx_tmp1,parent->get_height());
            		}
HXLINE(  86)		if (hx::IsNotNull( frame )) {
HXLINE(  88)			if (hx::IsNotNull( this->_frame )) {
HXLINE(  88)				this->_frame->copyFrom(frame);
            			}
            			else {
HXLINE(  89)				this->_frame = frame->clone();
            			}
            		}
            		else {
HXLINE(  91)			this->_frame = null();
            		}
HXLINE(  93)		this->_parent = parent;
HXLINE(  94)		this->_ownsParent = ownsParent;
HXLINE(  95)		this->_rotated = rotated;
HXLINE(  96)		Float _hx_tmp2;
HXDLIN(  96)		if (rotated) {
HXLINE(  96)			_hx_tmp2 = this->_region->height;
            		}
            		else {
HXLINE(  96)			_hx_tmp2 = this->_region->width;
            		}
HXDLIN(  96)		this->_width = ((Float)_hx_tmp2 / (Float)scaleModifier);
HXLINE(  97)		Float _hx_tmp3;
HXDLIN(  97)		if (rotated) {
HXLINE(  97)			_hx_tmp3 = this->_region->width;
            		}
            		else {
HXLINE(  97)			_hx_tmp3 = this->_region->height;
            		}
HXDLIN(  97)		this->_height = ((Float)_hx_tmp3 / (Float)scaleModifier);
HXLINE(  98)		this->_scale = (this->_parent->get_scale() * scaleModifier);
HXLINE( 100)		bool _hx_tmp4;
HXDLIN( 100)		if (hx::IsNotNull( this->_frame )) {
HXLINE( 100)			bool _hx_tmp5;
HXDLIN( 100)			bool _hx_tmp6;
HXDLIN( 100)			if (!((this->_frame->x > (int)0))) {
HXLINE( 100)				_hx_tmp6 = (this->_frame->y > (int)0);
            			}
            			else {
HXLINE( 100)				_hx_tmp6 = true;
            			}
HXDLIN( 100)			if (!(_hx_tmp6)) {
HXLINE( 101)				Float _hx_tmp7 = this->_frame->get_right();
HXLINE( 100)				_hx_tmp5 = (_hx_tmp7 < this->_width);
            			}
            			else {
HXLINE( 100)				_hx_tmp5 = true;
            			}
HXDLIN( 100)			if (!(_hx_tmp5)) {
HXLINE( 101)				Float _hx_tmp8 = this->_frame->get_bottom();
HXLINE( 100)				_hx_tmp4 = (_hx_tmp8 < this->_height);
            			}
            			else {
...
HXLINE( 103)			::haxe::Log_obj::trace(HX_("[Starling] Warning: frames inside the texture's region are unsupported.",63,b7,12,23),hx::SourceInfo(HX_("SubTexture.hx",43,12,6d,a6),103,HX_("starling.textures.SubTexture",2b,1a,57,50),HX_("setTo",bd,91,2f,7a)));
            		}
HXLINE( 106)		this->updateMatrices();
            	}
...
void SubTexture_obj::updateMatrices(){
            	HX_GC_STACKFRAME(&_hx_pos_2264be4ccebe9e60_110_updateMatrices)
HXLINE( 111)		if (hx::IsNotNull( this->_transformationMatrix )) {
HXLINE( 111)			this->_transformationMatrix->identity();
            		}
            		else {
HXLINE( 112)			this->_transformationMatrix =  ::openfl::geom::Matrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
            		}
HXLINE( 114)		if (hx::IsNotNull( this->_transformationMatrixToRoot )) {
HXLINE( 114)			this->_transformationMatrixToRoot->identity();
            		}
            		else {
HXLINE( 115)			this->_transformationMatrixToRoot =  ::openfl::geom::Matrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
            		}
HXLINE( 117)		if (this->_rotated) {
HXLINE( 119)			this->_transformationMatrix->translate((int)0,(int)-1);
HXLINE( 120)			 ::openfl::geom::Matrix _hx_tmp = this->_transformationMatrix;
HXDLIN( 120)			_hx_tmp->rotate(((Float)::Math_obj::PI / (Float)((Float)2.0)));
            		}
HXLINE( 123)		 ::openfl::geom::Matrix _hx_tmp1 = this->_transformationMatrix;
HXDLIN( 123)		Float _hx_tmp2 = this->_region->width;
HXDLIN( 123)		Float _hx_tmp3 = ((Float)_hx_tmp2 / (Float)this->_parent->get_width());
HXLINE( 124)		Float _hx_tmp4 = this->_region->height;
HXLINE( 123)		_hx_tmp1->scale(_hx_tmp3,((Float)_hx_tmp4 / (Float)this->_parent->get_height()));
HXLINE( 125)		 ::openfl::geom::Matrix _hx_tmp5 = this->_transformationMatrix;
HXDLIN( 125)		Float _hx_tmp6 = this->_region->x;
HXDLIN( 125)		Float _hx_tmp7 = ((Float)_hx_tmp6 / (Float)this->_parent->get_width());
HXLINE( 126)		Float _hx_tmp8 = this->_region->y;
HXLINE( 125)		_hx_tmp5->translate(_hx_tmp7,((Float)_hx_tmp8 / (Float)this->_parent->get_height()));
HXLINE( 128)		 ::starling::textures::SubTexture texture = hx::ObjectPtr<OBJ_>(this);
HXLINE( 129)		while(hx::IsNotNull( texture )){
HXLINE( 131)			this->_transformationMatrixToRoot->concat(texture->_transformationMatrix);
HXLINE( 132)			if (::Std_obj::is(texture->get_parent(),hx::ClassOf< ::starling::textures::SubTexture >())) {
HXLINE( 132)				texture = ( ( ::starling::textures::SubTexture)(texture->get_parent()) );
            			}
            			else {
HXLINE( 132)				texture = null();
            			}
            		}
            	}
...
void SubTexture_obj::dispose(){
            	HX_STACKFRAME(&_hx_pos_2264be4ccebe9e60_138_dispose)
HXLINE( 139)		if (this->_ownsParent) {
HXLINE( 139)			this->_parent->dispose();
            		}
HXLINE( 140)		this->super::dispose();
 ...
 ::starling::textures::Texture SubTexture_obj::get_parent(){
            	HX_STACKFRAME(&_hx_pos_2264be4ccebe9e60_145_get_parent)
HXDLIN( 145)		return this->_parent;
            	}
...
bool SubTexture_obj::get_ownsParent(){
            	HX_STACKFRAME(&_hx_pos_2264be4ccebe9e60_149_get_ownsParent)
HXDLIN( 149)		return this->_ownsParent;
            	}
...
bool SubTexture_obj::get_rotated(){
            	HX_STACKFRAME(&_hx_pos_2264be4ccebe9e60_153_get_rotated)
HXDLIN( 153)		return this->_rotated;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(SubTexture_obj,get_rotated,return )
 ...
 ::openfl::geom::Rectangle SubTexture_obj::get_region(){
            	HX_STACKFRAME(&_hx_pos_2264be4ccebe9e60_159_get_region)
HXDLIN( 159)		return this->_region;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(SubTexture_obj,get_region,return )
 ...
 ::openfl::geom::Matrix SubTexture_obj::get_transformationMatrix(){
            	HX_STACKFRAME(&_hx_pos_2264be4ccebe9e60_162_get_transformationMatrix)
HXDLIN( 162)		return this->_transformationMatrix;
            	}


 ::openfl::geom::Matrix SubTexture_obj::get_transformationMatrixToRoot(){
            	HX_STACKFRAME(&_hx_pos_2264be4ccebe9e60_165_get_transformationMatrixToRoot)
HXDLIN( 165)		return this->_transformationMatrixToRoot;
            	}


 ::openfl::display3D::textures::TextureBase SubTexture_obj::get_base(){
            	HX_STACKFRAME(&_hx_pos_2264be4ccebe9e60_168_get_base)
HXDLIN( 168)		return this->_parent->get_base();
            	}


 ::starling::textures::ConcreteTexture SubTexture_obj::get_root(){
            	HX_STACKFRAME(&_hx_pos_2264be4ccebe9e60_171_get_root)
HXDLIN( 171)		return this->_parent->get_root();
            	}


 ::Dynamic SubTexture_obj::get_format(){
            	HX_STACKFRAME(&_hx_pos_2264be4ccebe9e60_174_get_format)
HXDLIN( 174)		return this->_parent->get_format();
            	}


Float SubTexture_obj::get_width(){
            	HX_STACKFRAME(&_hx_pos_2264be4ccebe9e60_177_get_width)
HXDLIN( 177)		return this->_width;
            	}


Float SubTexture_obj::get_height(){
            	HX_STACKFRAME(&_hx_pos_2264be4ccebe9e60_180_get_height)
HXDLIN( 180)		return this->_height;
            	}


Float SubTexture_obj::get_nativeWidth(){
            	HX_STACKFRAME(&_hx_pos_2264be4ccebe9e60_183_get_nativeWidth)
HXDLIN( 183)		return (this->_width * this->_scale);
            	}


Float SubTexture_obj::get_nativeHeight(){
            	HX_STACKFRAME(&_hx_pos_2264be4ccebe9e60_186_get_nativeHeight)
HXDLIN( 186)		return (this->_height * this->_scale);
            	}


bool SubTexture_obj::get_mipMapping(){
            	HX_STACKFRAME(&_hx_pos_2264be4ccebe9e60_189_get_mipMapping)
HXDLIN( 189)		return this->_parent->get_mipMapping();
            	}


bool SubTexture_obj::get_premultipliedAlpha(){
            	HX_STACKFRAME(&_hx_pos_2264be4ccebe9e60_192_get_premultipliedAlpha)
HXDLIN( 192)		return this->_parent->get_premultipliedAlpha();
            	}


Float SubTexture_obj::get_scale(){
            	HX_STACKFRAME(&_hx_pos_2264be4ccebe9e60_195_get_scale)
HXDLIN( 195)		return this->_scale;
            	}


 ::openfl::geom::Rectangle SubTexture_obj::get_frame(){
            	HX_STACKFRAME(&_hx_pos_2264be4ccebe9e60_198_get_frame)
HXDLIN( 198)		return this->_frame;
            	}
