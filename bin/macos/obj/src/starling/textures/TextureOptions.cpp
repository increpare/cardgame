...
HX_LOCAL_STACK_FRAME(_hx_pos_8a5dc46981d2783b_57_clone,"starling.textures.TextureOptions","clone",0x87be4362,"starling.textures.TextureOptions.clone","starling/textures/TextureOptions.hx",57,0xbe71d20b)
HX_LOCAL_STACK_FRAME(_hx_pos_8a5dc46981d2783b_69_get_scale,"starling.textures.TextureOptions","get_scale",0x622c4166,"starling.textures.TextureOptions.get_scale","starling/textures/TextureOptions.hx",69,0xbe71d20b)
HX_LOCAL_STACK_FRAME(_hx_pos_8a5dc46981d2783b_72_set_scale,"starling.textures.TextureOptions","set_scale",0x457d2d72,"starling.textures.TextureOptions.set_scale","starling/textures/TextureOptions.hx",72,0xbe71d20b)
HX_LOCAL_STACK_FRAME(_hx_pos_8a5dc46981d2783b_79_get_format,"starling.textures.TextureOptions","get_format",0x45f59cdb,"starling.textures.TextureOptions.get_format","starling/textures/TextureOptions.hx",79,0xbe71d20b)
HX_LOCAL_STACK_FRAME(_hx_pos_8a5dc46981d2783b_80_set_format,"starling.textures.TextureOptions","set_format",0x49733b4f,"starling.textures.TextureOptions.set_format","starling/textures/TextureOptions.hx",80,0xbe71d20b)
HX_LOCAL_STACK_FRAME(_hx_pos_8a5dc46981d2783b_84_get_mipMapping,"starling.textures.TextureOptions","get_mipMapping",0x27bf5b7e,"starling.textures.TextureOptions.get_mipMapping","starling/textures/TextureOptions.hx",84,0xbe71d20b)
HX_LOCAL_STACK_FRAME(_hx_pos_8a5dc46981d2783b_85_set_mipMapping,"starling.textures.TextureOptions","set_mipMapping",0x47df43f2,"starling.textures.TextureOptions.set_mipMapping","starling/textures/TextureOptions.hx",85,0xbe71d20b)
HX_LOCAL_STACK_FRAME(_hx_pos_8a5dc46981d2783b_89_get_optimizeForRenderToTexture,"starling.textures.TextureOptions","get_optimizeForRenderToTexture",0x6c865142,"starling.textures.TextureOptions.get_optimizeForRenderToTexture","starling/textures/TextureOptions.hx",89,0xbe71d20b)
HX_LOCAL_STACK_FRAME(_hx_pos_8a5dc46981d2783b_90_set_optimizeForRenderToTexture,"starling.textures.TextureOptions","set_optimizeForRenderToTexture",0x477161b6,"starling.textures.TextureOptions.set_optimizeForRenderToTexture","starling/textures/TextureOptions.hx",90,0xbe71d20b)
HX_LOCAL_STACK_FRAME(_hx_pos_8a5dc46981d2783b_97_get_forcePotTexture,"starling.textures.TextureOptions","get_forcePotTexture",0xe96c276d,"starling.textures.TextureOptions.get_forcePotTexture","starling/textures/TextureOptions.hx",97,0xbe71d20b)
HX_LOCAL_STACK_FRAME(_hx_pos_8a5dc46981d2783b_98_set_forcePotTexture,"starling.textures.TextureOptions","set_forcePotTexture",0x26091a79,"starling.textures.TextureOptions.set_forcePotTexture","starling/textures/TextureOptions.hx",98,0xbe71d20b)
HX_LOCAL_STACK_FRAME(_hx_pos_8a5dc46981d2783b_109_get_onReady,"starling.textures.TextureOptions","get_onReady",0x8ebd20a0,"starling.textures.TextureOptions.get_onReady","starling/textures/TextureOptions.hx",109,0xbe71d20b)
HX_LOCAL_STACK_FRAME(_hx_pos_8a5dc46981d2783b_110_set_onReady,"starling.textures.TextureOptions","set_onReady",0x992a27ac,"starling.textures.TextureOptions.set_onReady","starling/textures/TextureOptions.hx",110,0xbe71d20b)
HX_LOCAL_STACK_FRAME(_hx_pos_8a5dc46981d2783b_117_get_premultipliedAlpha,"starling.textures.TextureOptions","get_premultipliedAlpha",0x56f381cc,"starling.textures.TextureOptions.get_premultipliedAlpha","starling/textures/TextureOptions.hx",117,0xbe71d20b)
HX_LOCAL_STACK_FRAME(_hx_pos_8a5dc46981d2783b_118_set_premultipliedAlpha,"starling.textures.TextureOptions","set_premultipliedAlpha",0x8a9efe40,"starling.textures.TextureOptions.set_premultipliedAlpha","starling/textures/TextureOptions.hx",118,0xbe71d20b)
namespace starling{
namespace textures{
...
HXLINE(  48)		this->_scale = scale;
HXLINE(  49)		this->_format = format;
HXLINE(  50)		this->_mipMapping = mipMapping;
HXLINE(  51)		this->_forcePotTexture = forcePotTexture;
HXLINE(  52)		this->_premultipliedAlpha = premultipliedAlpha;
            	}
...
bool TextureOptions_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::starling::textures::TextureOptions TextureOptions_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_8a5dc46981d2783b_57_clone)
HXLINE(  58)		 ::starling::textures::TextureOptions clone =  ::starling::textures::TextureOptions_obj::__alloc( HX_CTX ,this->_scale,this->_mipMapping,this->_format,null(),null());
HXLINE(  59)		clone->_optimizeForRenderToTexture = this->_optimizeForRenderToTexture;
HXLINE(  60)		clone->_premultipliedAlpha = this->_premultipliedAlpha;
HXLINE(  61)		clone->_forcePotTexture = this->_forcePotTexture;
HXLINE(  62)		clone->_onReady = this->_onReady;
HXLINE(  63)		return clone;
            	}
...
Float TextureOptions_obj::get_scale(){
            	HX_STACKFRAME(&_hx_pos_8a5dc46981d2783b_69_get_scale)
HXDLIN(  69)		return this->_scale;
            	}
...
Float TextureOptions_obj::set_scale(Float value){
            	HX_STACKFRAME(&_hx_pos_8a5dc46981d2783b_72_set_scale)
HXDLIN(  72)		Float _hx_tmp;
HXDLIN(  72)		if ((value > (int)0)) {
HXDLIN(  72)			_hx_tmp = value;
            		}
            		else {
HXDLIN(  72)			_hx_tmp = ::starling::core::Starling_obj::get_current()->get_contentScaleFactor();
            		}
HXDLIN(  72)		return (this->_scale = _hx_tmp);
            	}
...
::String TextureOptions_obj::get_format(){
            	HX_STACKFRAME(&_hx_pos_8a5dc46981d2783b_79_get_format)
HXDLIN(  79)		return this->_format;
            	}
...
::String TextureOptions_obj::set_format(::String value){
            	HX_STACKFRAME(&_hx_pos_8a5dc46981d2783b_80_set_format)
HXDLIN(  80)		return (this->_format = value);
            	}
...
bool TextureOptions_obj::get_mipMapping(){
            	HX_STACKFRAME(&_hx_pos_8a5dc46981d2783b_84_get_mipMapping)
HXDLIN(  84)		return this->_mipMapping;
            	}
...
bool TextureOptions_obj::set_mipMapping(bool value){
            	HX_STACKFRAME(&_hx_pos_8a5dc46981d2783b_85_set_mipMapping)
HXDLIN(  85)		return (this->_mipMapping = value);
            	}
...
bool TextureOptions_obj::get_optimizeForRenderToTexture(){
            	HX_STACKFRAME(&_hx_pos_8a5dc46981d2783b_89_get_optimizeForRenderToTexture)
HXDLIN(  89)		return this->_optimizeForRenderToTexture;
            	}
...
bool TextureOptions_obj::set_optimizeForRenderToTexture(bool value){
            	HX_STACKFRAME(&_hx_pos_8a5dc46981d2783b_90_set_optimizeForRenderToTexture)
HXDLIN(  90)		return (this->_optimizeForRenderToTexture = value);
            	}
...
bool TextureOptions_obj::get_forcePotTexture(){
            	HX_STACKFRAME(&_hx_pos_8a5dc46981d2783b_97_get_forcePotTexture)
HXDLIN(  97)		return this->_forcePotTexture;
            	}
...
bool TextureOptions_obj::set_forcePotTexture(bool value){
            	HX_STACKFRAME(&_hx_pos_8a5dc46981d2783b_98_set_forcePotTexture)
HXDLIN(  98)		return (this->_forcePotTexture = value);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(TextureOptions_obj,set_forcePotTexture,return )
 ...
 ::Dynamic TextureOptions_obj::get_onReady(){
            	HX_STACKFRAME(&_hx_pos_8a5dc46981d2783b_109_get_onReady)
HXDLIN( 109)		return this->_onReady;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(TextureOptions_obj,get_onReady,return )
 ...
 ::Dynamic TextureOptions_obj::set_onReady( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_8a5dc46981d2783b_110_set_onReady)
HXDLIN( 110)		return (this->_onReady = value);
            	}
...
bool TextureOptions_obj::get_premultipliedAlpha(){
            	HX_STACKFRAME(&_hx_pos_8a5dc46981d2783b_117_get_premultipliedAlpha)
HXDLIN( 117)		return this->_premultipliedAlpha;
            	}
...
bool TextureOptions_obj::set_premultipliedAlpha(bool value){
            	HX_STACKFRAME(&_hx_pos_8a5dc46981d2783b_118_set_premultipliedAlpha)
HXDLIN( 118)		return (this->_premultipliedAlpha = value);
            	}
