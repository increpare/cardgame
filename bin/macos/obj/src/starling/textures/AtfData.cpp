...
HX_DEFINE_STACK_FRAME(_hx_pos_bbc060256f9e9a5c_45_new,"starling.textures.AtfData","new",0x853eca5f,"starling.textures.AtfData.new","starling/textures/AtfData.hx",45,0x3711f5d1)
HX_LOCAL_STACK_FRAME(_hx_pos_bbc060256f9e9a5c_90_get_format,"starling.textures.AtfData","get_format",0x44abd2e1,"starling.textures.AtfData.get_format","starling/textures/AtfData.hx",90,0x3711f5d1)
HX_LOCAL_STACK_FRAME(_hx_pos_bbc060256f9e9a5c_94_get_width,"starling.textures.AtfData","get_width",0xead9159c,"starling.textures.AtfData.get_width","starling/textures/AtfData.hx",94,0x3711f5d1)
HX_LOCAL_STACK_FRAME(_hx_pos_bbc060256f9e9a5c_98_get_height,"starling.textures.AtfData","get_height",0x49694b91,"starling.textures.AtfData.get_height","starling/textures/AtfData.hx",98,0x3711f5d1)
HX_LOCAL_STACK_FRAME(_hx_pos_bbc060256f9e9a5c_102_get_numTextures,"starling.textures.AtfData","get_numTextures",0x03807bb4,"starling.textures.AtfData.get_numTextures","starling/textures/AtfData.hx",102,0x3711f5d1)
HX_LOCAL_STACK_FRAME(_hx_pos_bbc060256f9e9a5c_106_get_isCubeMap,"starling.textures.AtfData","get_isCubeMap",0x937bac73,"starling.textures.AtfData.get_isCubeMap","starling/textures/AtfData.hx",106,0x3711f5d1)
HX_LOCAL_STACK_FRAME(_hx_pos_bbc060256f9e9a5c_110_get_data,"starling.textures.AtfData","get_data",0xfecd7b54,"starling.textures.AtfData.get_data","starling/textures/AtfData.hx",110,0x3711f5d1)
HX_LOCAL_STACK_FRAME(_hx_pos_bbc060256f9e9a5c_80_isAtfData,"starling.textures.AtfData","isAtfData",0xebef0852,"starling.textures.AtfData.isAtfData","starling/textures/AtfData.hx",80,0x3711f5d1)
namespace starling{
namespace textures{

void AtfData_obj::__construct( ::openfl::utils::ByteArrayData data){
            	HX_GC_STACKFRAME(&_hx_pos_bbc060256f9e9a5c_45_new)
HXLINE(  46)		if (!(::starling::textures::AtfData_obj::isAtfData(data))) {
HXLINE(  46)			HX_STACK_DO_THROW( ::openfl::errors::ArgumentError_obj::__alloc( HX_CTX ,HX_("Invalid ATF data",e0,a3,f9,e4)));
            		}
HXLINE(  48)		if ((data->b->__get((int)6) == (int)255)) {
HXLINE(  48)			data->position = (int)12;
            		}
            		else {
HXLINE(  49)			data->position = (int)6;
            		}
HXLINE(  51)		int format = data->readUnsignedByte();
HXLINE(  52)		{
HXLINE(  52)			int _g = ((int)format & (int)(int)127);
HXDLIN(  52)			switch((int)(_g)){
            				case (int)0: case (int)1: {
HXLINE(  54)					this->_format = ::openfl::display3D::_Context3DTextureFormat::Context3DTextureFormat_Impl__obj::toString((int)1);
            				}
            				break;
            				case (int)2: case (int)3: case (int)12: {
HXLINE(  55)					this->_format = ::openfl::display3D::_Context3DTextureFormat::Context3DTextureFormat_Impl__obj::toString((int)3);
            				}
            				break;
            				case (int)4: case (int)5: case (int)13: {
HXLINE(  56)					this->_format = HX_("compressedAlpha",1d,d7,1f,4a);
            				}
            				break;
            				default:{
HXLINE(  57)					HX_STACK_DO_THROW( ::openfl::errors::Error_obj::__alloc( HX_CTX ,HX_("Invalid ATF format",6d,36,9c,2c),null()));
            				}
            			}
            		}
HXLINE(  60)		this->_width = ::Std_obj::_hx_int(::Math_obj::pow((int)2,data->readUnsignedByte()));
HXLINE(  61)		this->_height = ::Std_obj::_hx_int(::Math_obj::pow((int)2,data->readUnsignedByte()));
HXLINE(  62)		this->_numTextures = data->readUnsignedByte();
HXLINE(  63)		this->_isCubeMap = (((int)format & (int)(int)128) != (int)0);
HXLINE(  64)		this->_data = data;
HXLINE(  69)		bool _hx_tmp;
HXDLIN(  69)		if ((data->b->__get((int)5) != (int)0)) {
HXLINE(  69)			_hx_tmp = (data->b->__get((int)6) == (int)255);
            		}
            		else {
HXLINE(  69)			_hx_tmp = false;
            		}
HXDLIN(  69)		if (_hx_tmp) {
HXLINE(  71)			bool emptyMipmaps = (((int)data->b->__get((int)5) & (int)(int)1) == (int)1);
HXLINE(  72)			int numTextures = ((int)((int)data->b->__get((int)5) >> (int)(int)1) & (int)(int)127);
HXLINE(  73)			int _hx_tmp1;
HXDLIN(  73)			if (emptyMipmaps) {
HXLINE(  73)				_hx_tmp1 = (int)1;
            			}
            			else {
HXLINE(  73)				_hx_tmp1 = numTextures;
            			}
HXDLIN(  73)			this->_numTextures = _hx_tmp1;
            		}
            	}
...
::String AtfData_obj::get_format(){
            	HX_STACKFRAME(&_hx_pos_bbc060256f9e9a5c_90_get_format)
HXDLIN(  90)		return this->_format;
            	}
...
int AtfData_obj::get_width(){
            	HX_STACKFRAME(&_hx_pos_bbc060256f9e9a5c_94_get_width)
HXDLIN(  94)		return this->_width;
            	}
...
int AtfData_obj::get_height(){
            	HX_STACKFRAME(&_hx_pos_bbc060256f9e9a5c_98_get_height)
HXDLIN(  98)		return this->_height;
            	}
...
int AtfData_obj::get_numTextures(){
            	HX_STACKFRAME(&_hx_pos_bbc060256f9e9a5c_102_get_numTextures)
HXDLIN( 102)		return this->_numTextures;
            	}
...
bool AtfData_obj::get_isCubeMap(){
            	HX_STACKFRAME(&_hx_pos_bbc060256f9e9a5c_106_get_isCubeMap)
HXDLIN( 106)		return this->_isCubeMap;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(AtfData_obj,get_isCubeMap,return )
 ...
 ::openfl::utils::ByteArrayData AtfData_obj::get_data(){
            	HX_STACKFRAME(&_hx_pos_bbc060256f9e9a5c_110_get_data)
HXDLIN( 110)		return this->_data;
            	}
...
bool AtfData_obj::isAtfData( ::openfl::utils::ByteArrayData data){
            	HX_STACKFRAME(&_hx_pos_bbc060256f9e9a5c_80_isAtfData)
HXDLIN(  80)		if ((::openfl::utils::_ByteArray::ByteArray_Impl__obj::get_length(data) < (int)3)) {
HXDLIN(  80)			return false;
            		}
            		else {
HXLINE(  83)			::String signature = ::String::fromCharCode(data->b->__get((int)0));
HXDLIN(  83)			::String signature1 = (signature + ::String::fromCharCode(data->b->__get((int)1)));
HXDLIN(  83)			::String signature2 = (signature1 + ::String::fromCharCode(data->b->__get((int)2)));
HXLINE(  84)			return (signature2 == HX_("ATF",f3,9b,31,00));
            		}
