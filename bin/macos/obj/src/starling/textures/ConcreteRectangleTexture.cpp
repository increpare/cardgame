...
HX_DEFINE_STACK_FRAME(_hx_pos_53752f3d3b9d3278_49_new,"starling.textures.ConcreteRectangleTexture","new",0x10111d33,"starling.textures.ConcreteRectangleTexture.new","starling/textures/ConcreteRectangleTexture.hx",49,0x7b10ddbd)
HX_LOCAL_STACK_FRAME(_hx_pos_53752f3d3b9d3278_55_uploadBitmapData,"starling.textures.ConcreteRectangleTexture","uploadBitmapData",0x09495a67,"starling.textures.ConcreteRectangleTexture.uploadBitmapData","starling/textures/ConcreteRectangleTexture.hx",55,0x7b10ddbd)
HX_LOCAL_STACK_FRAME(_hx_pos_53752f3d3b9d3278_66_createBase,"starling.textures.ConcreteRectangleTexture","createBase",0x83f6ecba,"starling.textures.ConcreteRectangleTexture.createBase","starling/textures/ConcreteRectangleTexture.hx",66,0x7b10ddbd)
HX_LOCAL_STACK_FRAME(_hx_pos_53752f3d3b9d3278_73_get_rectBase,"starling.textures.ConcreteRectangleTexture","get_rectBase",0x4adc782b,"starling.textures.ConcreteRectangleTexture.get_rectBase","starling/textures/ConcreteRectangleTexture.hx",73,0x7b10ddbd)
HX_LOCAL_STACK_FRAME(_hx_pos_53752f3d3b9d3278_80_upload,"starling.textures.ConcreteRectangleTexture","upload",0xf86c030e,"starling.textures.ConcreteRectangleTexture.upload","starling/textures/ConcreteRectangleTexture.hx",80,0x7b10ddbd)
HX_LOCAL_STACK_FRAME(_hx_pos_53752f3d3b9d3278_93_uploadAsync,"starling.textures.ConcreteRectangleTexture","uploadAsync",0x6493994e,"starling.textures.ConcreteRectangleTexture.uploadAsync","starling/textures/ConcreteRectangleTexture.hx",93,0x7b10ddbd)
HX_LOCAL_STACK_FRAME(_hx_pos_53752f3d3b9d3278_110_uploadAsync,"starling.textures.ConcreteRectangleTexture","uploadAsync",0x6493994e,"starling.textures.ConcreteRectangleTexture.uploadAsync","starling/textures/ConcreteRectangleTexture.hx",110,0x7b10ddbd)
HX_LOCAL_STACK_FRAME(_hx_pos_53752f3d3b9d3278_117_onTextureReady,"starling.textures.ConcreteRectangleTexture","onTextureReady",0x4dff3b54,"starling.textures.ConcreteRectangleTexture.onTextureReady","starling/textures/ConcreteRectangleTexture.hx",117,0x7b10ddbd)
HX_LOCAL_STACK_FRAME(_hx_pos_53752f3d3b9d3278_128_get_asyncUploadEnabled,"starling.textures.ConcreteRectangleTexture","get_asyncUploadEnabled",0xf390ebfa,"starling.textures.ConcreteRectangleTexture.get_asyncUploadEnabled","starling/textures/ConcreteRectangleTexture.hx",128,0x7b10ddbd)
HX_LOCAL_STACK_FRAME(_hx_pos_53752f3d3b9d3278_129_set_asyncUploadEnabled,"starling.textures.ConcreteRectangleTexture","set_asyncUploadEnabled",0x273c686e,"starling.textures.ConcreteRectangleTexture.set_asyncUploadEnabled","starling/textures/ConcreteRectangleTexture.hx",129,0x7b10ddbd)
...
Float scale = __o_scale.Default(1);
            	HX_STACKFRAME(&_hx_pos_53752f3d3b9d3278_49_new)
HXDLIN(  49)		super::__construct(base,format,width,height,false,premultipliedAlpha,optimizedForRenderTexture,scale);
            	}
...
void ConcreteRectangleTexture_obj::uploadBitmapData( ::openfl::display::BitmapData data, ::Dynamic async){
            	HX_STACKFRAME(&_hx_pos_53752f3d3b9d3278_55_uploadBitmapData)
HXLINE(  56)		if (hx::IsNotNull( async )) {
HXLINE(  57)			this->_textureReadyCallback = async;
            		}
HXLINE(  59)		this->upload(data,hx::IsNotNull( async ));
HXLINE(  60)		this->setDataUploaded();
            	}


 ::openfl::display3D::textures::TextureBase ConcreteRectangleTexture_obj::createBase(){
            	HX_STACKFRAME(&_hx_pos_53752f3d3b9d3278_66_createBase)
HXDLIN(  66)		 ::openfl::display3D::Context3D _hx_tmp = ::starling::core::Starling_obj::get_current()->get_context();
HXLINE(  67)		int _hx_tmp1 = ::Std_obj::_hx_int(this->get_nativeWidth());
HXDLIN(  67)		int _hx_tmp2 = ::Std_obj::_hx_int(this->get_nativeHeight());
HXDLIN(  67)		 ::Dynamic _hx_tmp3 = this->get_format();
HXLINE(  66)		return _hx_tmp->createRectangleTexture(_hx_tmp1,_hx_tmp2,_hx_tmp3,this->get_optimizedForRenderTexture());
            	}


 ::openfl::display3D::textures::RectangleTexture ConcreteRectangleTexture_obj::get_rectBase(){
            	HX_STACKFRAME(&_hx_pos_53752f3d3b9d3278_73_get_rectBase)
HXDLIN(  73)		return ( ( ::openfl::display3D::textures::RectangleTexture)(this->get_base()) );
            	}
...
void ConcreteRectangleTexture_obj::upload( ::openfl::display::BitmapData source,bool isAsync){
            	HX_STACKFRAME(&_hx_pos_53752f3d3b9d3278_80_upload)
HXDLIN(  80)		if (isAsync) {
HXLINE(  82)			this->uploadAsync(source);
HXLINE(  83)			this->get_base()->addEventListener(HX_("textureReady",88,4d,5a,df),this->onTextureReady_dyn(),null(),null(),null());
HXLINE(  84)			this->get_base()->addEventListener(HX_("error",c8,cb,29,73),this->onTextureReady_dyn(),null(),null(),null());
            		}
            		else {
HXLINE(  88)			this->get_rectBase()->uploadFromBitmapData(source);
            		}
            	}
...
void ConcreteRectangleTexture_obj::uploadAsync( ::openfl::display::BitmapData source){
            	HX_STACKFRAME(&_hx_pos_53752f3d3b9d3278_93_uploadAsync)
HXLINE(  92)		 ::starling::textures::ConcreteRectangleTexture _gthis = hx::ObjectPtr<OBJ_>(this);
HXLINE(  94)		if (::starling::textures::ConcreteRectangleTexture_obj::sAsyncUploadEnabled) {
HXLINE(  96)			 ::Dynamic method = ::Reflect_obj::field(this->get_base(),HX_("uploadFromBitmapDataAsync",f8,f6,6a,07));
HXLINE(  97)			try {
            				HX_STACK_CATCHABLE( ::openfl::errors::Error, 0);
HXLINE(  97)				::Reflect_obj::callMethod(method,method,::cpp::VirtualArray_obj::__new(1)->init(0,source));
            			}
            			catch( ::Dynamic _hx_e){
...
HXDLIN( 100)					if ((error->errorID != (int)3708)) {
HXLINE( 100)						_hx_tmp = (error->errorID == (int)1069);
            					}
            					else {
HXLINE( 100)						_hx_tmp = true;
            					}
HXDLIN( 100)					if (_hx_tmp) {
HXLINE( 101)						::starling::textures::ConcreteRectangleTexture_obj::sAsyncUploadEnabled = false;
            					}
            					else {
HXLINE( 103)						HX_STACK_DO_THROW(error);
            					}
            				}
            				else {
...
HXLINE( 107)		if (!(::starling::textures::ConcreteRectangleTexture_obj::sAsyncUploadEnabled)) {
            			HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_hx_Closure_0, ::starling::textures::ConcreteRectangleTexture,_gthis) HXARGC(0)
            			void _hx_run(){
            				HX_GC_STACKFRAME(&_hx_pos_53752f3d3b9d3278_110_uploadAsync)
HXLINE( 110)				 ::openfl::display3D::textures::TextureBase _hx_tmp1 = _gthis->get_base();
HXDLIN( 110)				_hx_tmp1->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("textureReady",88,4d,5a,df),null(),null()));
            			}
            			HX_END_LOCAL_FUNC0((void))

HXLINE( 109)			::haxe::Timer_obj::delay( ::Dynamic(new _hx_Closure_0(_gthis)),(int)1);
HXLINE( 112)			this->get_rectBase()->uploadFromBitmapData(source);
            		}
            	}
...
void ConcreteRectangleTexture_obj::onTextureReady( ::openfl::events::Event event){
            	HX_STACKFRAME(&_hx_pos_53752f3d3b9d3278_117_onTextureReady)
HXLINE( 118)		this->get_base()->removeEventListener(HX_("textureReady",88,4d,5a,df),this->onTextureReady_dyn(),null());
HXLINE( 119)		this->get_base()->removeEventListener(HX_("error",c8,cb,29,73),this->onTextureReady_dyn(),null());
HXLINE( 121)		if (hx::IsNotNull( this->_textureReadyCallback )) {
HXLINE( 122)			this->_textureReadyCallback(hx::ObjectPtr<OBJ_>(this));
            		}
HXLINE( 123)		this->_textureReadyCallback = null();
            	}
...
bool ConcreteRectangleTexture_obj::get_asyncUploadEnabled(){
            	HX_STACKFRAME(&_hx_pos_53752f3d3b9d3278_128_get_asyncUploadEnabled)
HXDLIN( 128)		return ::starling::textures::ConcreteRectangleTexture_obj::sAsyncUploadEnabled;
            	}
...
bool ConcreteRectangleTexture_obj::set_asyncUploadEnabled(bool value){
            	HX_STACKFRAME(&_hx_pos_53752f3d3b9d3278_129_set_asyncUploadEnabled)
HXDLIN( 129)		return (::starling::textures::ConcreteRectangleTexture_obj::sAsyncUploadEnabled = value);
            	}
