...
HXLINE(  51)		::openfl::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__OPENFL__data_fonts_rosarivo_regular_ttf >());
HXLINE(  52)		::openfl::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__OPENFL__data_fonts_germaniaone_regular_ttf >());
HXLINE(  53)		::openfl::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__OPENFL__data_fonts_rosarivo_italic_ttf >());
