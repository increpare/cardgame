...
HX_LOCAL_STACK_FRAME(_hx_pos_67382ab39e6adff2_257_get_length,"openfl.utils._ByteArray.ByteArray_Impl_","get_length",0xd68ebb4d,"openfl.utils._ByteArray.ByteArray_Impl_.get_length","openfl/utils/ByteArray.hx",257,0xaa5cee4a)
HX_LOCAL_STACK_FRAME(_hx_pos_67382ab39e6adff2_263_set_length,"openfl.utils._ByteArray.ByteArray_Impl_","set_length",0xda0c59c1,"openfl.utils._ByteArray.ByteArray_Impl_.set_length","openfl/utils/ByteArray.hx",263,0xaa5cee4a)
...
int ByteArray_Impl__obj::get_length( ::openfl::utils::ByteArrayData this1){
            	HX_STACKFRAME(&_hx_pos_67382ab39e6adff2_257_get_length)
HXDLIN( 257)		if (hx::IsNull( this1 )) {
HXDLIN( 257)			return (int)0;
            		}
            		else {
HXDLIN( 257)			return this1->length;
            		}
HXDLIN( 257)		return (int)0;
            	}
...
int ByteArray_Impl__obj::set_length( ::openfl::utils::ByteArrayData this1,int value){
            	HX_STACKFRAME(&_hx_pos_67382ab39e6adff2_263_set_length)
HXLINE( 271)		if ((value > (int)0)) {
HXLINE( 273)			this1->_hx___resize(value);
HXLINE( 274)			if ((value < this1->position)) {
HXLINE( 274)				this1->position = value;
            			}
            		}
HXLINE( 278)		this1->length = value;
