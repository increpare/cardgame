...
HX_DEFINE_STACK_FRAME(_hx_pos_e7c49b2409073623_905_new,"openfl.display._MovieClip.FrameSymbolInstance","new",0xd335e789,"openfl.display._MovieClip.FrameSymbolInstance.new","openfl/display/MovieClip.hx",905,0x2b84738a)
namespace openfl{
namespace display{
...
void FrameSymbolInstance_obj::__construct(int initFrame,int initFrameObjectID,int characterID,int depth, ::openfl::display::DisplayObject displayObject,int clipDepth){
            	HX_STACKFRAME(&_hx_pos_e7c49b2409073623_905_new)
HXLINE( 907)		this->initFrame = initFrame;
HXLINE( 908)		this->initFrameObjectID = initFrameObjectID;
HXLINE( 909)		this->characterID = characterID;
HXLINE( 910)		this->depth = depth;
HXLINE( 911)		this->displayObject = displayObject;
HXLINE( 912)		this->clipDepth = clipDepth;
            	}
