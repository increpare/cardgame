...
HXDLIN( 214)		this->_hx___registerLookup =  ::openfl::_Vector::AbstractVector_obj::__alloc( HX_CTX , ::openfl::_Vector::ObjectVector_obj::__alloc( HX_CTX ,total,fixed,null()),null());
HXLINE( 216)		{
...
HXLINE( 220)						::openfl::_Vector::IVector_obj::set(this->_hx___registerLookup->data,(uniform1->regIndex + i),uniform1);
            					}
            				}
            			}
            		}
...
HXLINE( 271)		if ((end > ::openfl::_Vector::IVector_obj::get_length(this->_hx___registerLookup->data))) {
HXLINE( 273)			end = ::openfl::_Vector::IVector_obj::get_length(this->_hx___registerLookup->data);
            		}
HXLINE( 277)		int index = start;
HXLINE( 279)		while((index < end)){
HXLINE( 281)			 ::openfl::display3D::Uniform uniform = ( ( ::openfl::display3D::Uniform)(::openfl::_Vector::IVector_obj::get(this->_hx___registerLookup->data,index)) );
