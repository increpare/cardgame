...
HXDLIN(  56)		this->_hx___samplerStates =  ::openfl::_Vector::AbstractVector_obj::__alloc( HX_CTX , ::openfl::_Vector::ObjectVector_obj::__alloc( HX_CTX ,(int)8,fixed,null()),null());
            	}
...
HXDLIN(  63)		::openfl::_internal::stage3D::opengl::GLProgram3D_obj::dispose(hx::ObjectPtr<OBJ_>(this),this->_hx___context->_hx___renderSession);
            	}
...
HXDLIN(  70)		::openfl::_internal::stage3D::opengl::GLProgram3D_obj::upload(hx::ObjectPtr<OBJ_>(this),this->_hx___context->_hx___renderSession,vertexProgram,fragmentProgram);
            	}
...
HXDLIN(  85)		return ( ( ::openfl::_internal::stage3D::SamplerState)(::openfl::_Vector::IVector_obj::get(this->_hx___samplerStates->data,sampler)) );
            	}
...
HXLINE( 109)			::openfl::_internal::stage3D::opengl::GLProgram3D_obj::setPositionScale(hx::ObjectPtr<OBJ_>(this),this->_hx___context->_hx___renderSession,positionScale);
            		}
            	}
...
HXDLIN( 118)		::openfl::_Vector::IVector_obj::set(this->_hx___samplerStates->data,sampler,state);
            	}
...
HXDLIN( 125)		::openfl::_internal::stage3D::opengl::GLProgram3D_obj::use(hx::ObjectPtr<OBJ_>(this),this->_hx___context->_hx___renderSession);
            	}
