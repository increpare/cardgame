...
HX_LOCAL_STACK_FRAME(_hx_pos_ee23285ac806d27a_20_fromString,"openfl.display3D._Context3DProfile.Context3DProfile_Impl_","fromString",0xdbdb0761,"openfl.display3D._Context3DProfile.Context3DProfile_Impl_.fromString","openfl/display3D/Context3DProfile.hx",20,0x8638b9ba)
HX_LOCAL_STACK_FRAME(_hx_pos_ee23285ac806d27a_36_toString,"openfl.display3D._Context3DProfile.Context3DProfile_Impl_","toString",0xda661cb2,"openfl.display3D._Context3DProfile.Context3DProfile_Impl_.toString","openfl/display3D/Context3DProfile.hx",36,0x8638b9ba)
...
bool Context3DProfile_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Context3DProfile_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_ee23285ac806d27a_20_fromString)
...
::String Context3DProfile_Impl__obj::toString(int value){
            	HX_STACKFRAME(&_hx_pos_ee23285ac806d27a_36_toString)
HXDLIN(  36)		switch((int)(value)){
            			case (int)0: {
HXLINE(  38)				return HX_("baseline",85,dc,27,11);
            			}
            			break;
            			case (int)1: {
HXLINE(  39)				return HX_("baselineConstrained",d1,73,c8,e8);
            			}
            			break;
            			case (int)2: {
HXLINE(  40)				return HX_("baselineExtended",5e,fa,57,d8);
            			}
            			break;
            			case (int)3: {
HXLINE(  41)				return HX_("standard",3d,37,78,ea);
            			}
            			break;
            			case (int)4: {
HXLINE(  42)				return HX_("standardConstrained",19,24,99,7f);
            			}
            			break;
            			case (int)5: {
HXLINE(  43)				return HX_("standardExtended",16,cd,15,fe);
            			}
            			break;
            			default:{
