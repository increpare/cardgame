...
HXDLIN(  51)						{
HXLINE(  51)							 ::Dynamic _hx_tmp11 =  ::Dynamic( ::Dynamic(shader->get_data()->__Field(HX_("aColorMultipliers0",80,f6,6a,dd),hx::paccDynamic))->__Field(HX_("index",12,9b,14,be),hx::paccDynamic));
...
HXDLIN(  51)							 ::Dynamic _hx_tmp12 =  ::Dynamic( ::Dynamic(shader->get_data()->__Field(HX_("aColorMultipliers1",81,f6,6a,dd),hx::paccDynamic))->__Field(HX_("index",12,9b,14,be),hx::paccDynamic));
...
HXDLIN(  51)							 ::Dynamic _hx_tmp13 =  ::Dynamic( ::Dynamic(shader->get_data()->__Field(HX_("aColorMultipliers2",82,f6,6a,dd),hx::paccDynamic))->__Field(HX_("index",12,9b,14,be),hx::paccDynamic));
...
HXDLIN(  51)							 ::Dynamic _hx_tmp14 =  ::Dynamic( ::Dynamic(shader->get_data()->__Field(HX_("aColorMultipliers3",83,f6,6a,dd),hx::paccDynamic))->__Field(HX_("index",12,9b,14,be),hx::paccDynamic));
