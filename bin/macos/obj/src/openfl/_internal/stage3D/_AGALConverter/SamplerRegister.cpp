...
HX_DEFINE_STACK_FRAME(_hx_pos_4fd42e04ab930eb2_977_new,"openfl._internal.stage3D._AGALConverter.SamplerRegister","new",0xf340d88e,"openfl._internal.stage3D._AGALConverter.SamplerRegister.new","openfl/_internal/stage3D/AGALConverter.hx",977,0x0a35cc61)
HX_LOCAL_STACK_FRAME(_hx_pos_4fd42e04ab930eb2_1002_toGLSL,"openfl._internal.stage3D._AGALConverter.SamplerRegister","toGLSL",0xc158218b,"openfl._internal.stage3D._AGALConverter.SamplerRegister.toGLSL","openfl/_internal/stage3D/AGALConverter.hx",1002,0x0a35cc61)
HX_LOCAL_STACK_FRAME(_hx_pos_4fd42e04ab930eb2_1010_toSamplerState,"openfl._internal.stage3D._AGALConverter.SamplerRegister","toSamplerState",0x8ed80c96,"openfl._internal.stage3D._AGALConverter.SamplerRegister.toSamplerState","openfl/_internal/stage3D/AGALConverter.hx",1010,0x0a35cc61)
HX_LOCAL_STACK_FRAME(_hx_pos_4fd42e04ab930eb2_984_parse,"openfl._internal.stage3D._AGALConverter.SamplerRegister","parse",0x0bb77fe1,"openfl._internal.stage3D._AGALConverter.SamplerRegister.parse","openfl/_internal/stage3D/AGALConverter.hx",984,0x0a35cc61)
namespace openfl{
namespace _internal{
namespace stage3D{
...
void SamplerRegister_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_4fd42e04ab930eb2_977_new)
            	}
...
::String SamplerRegister_obj::toGLSL(){
            	HX_STACKFRAME(&_hx_pos_4fd42e04ab930eb2_1002_toGLSL)
HXLINE(1004)		::String str = ::openfl::_internal::stage3D::AGALConverter_obj::prefixFromType(this->type,this->programType);
HXDLIN(1004)		::String str1 = (str + this->n);
HXLINE(1005)		return str1;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(SamplerRegister_obj,toGLSL,return )
 ...
 ::openfl::_internal::stage3D::SamplerState SamplerRegister_obj::toSamplerState(){
            	HX_GC_STACKFRAME(&_hx_pos_4fd42e04ab930eb2_1010_toSamplerState)
HXLINE(1012)		int magFilter = (int)0;
HXLINE(1013)		int minFilter = (int)0;
HXLINE(1014)		int wrapModeS = (int)0;
HXLINE(1015)		int wrapModeT = (int)0;
HXLINE(1018)		{
HXLINE(1018)			int _g = this->f;
HXDLIN(1018)			switch((int)(_g)){
            				case (int)0: {
HXLINE(1020)					magFilter = (int)9728;
            				}
            				break;
            				case (int)1: {
HXLINE(1021)					magFilter = (int)9729;
            				}
            				break;
            				default:{
HXLINE(1022)					HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,null()));
            				}
            			}
            		}
HXLINE(1027)		{
HXLINE(1027)			int _g1 = this->m;
HXDLIN(1027)			switch((int)(_g1)){
            				case (int)0: {
HXLINE(1032)					if ((this->f != (int)0)) {
HXLINE(1032)						minFilter = (int)9729;
            					}
            					else {
HXLINE(1032)						minFilter = (int)9728;
            					}
            				}
            				break;
            				case (int)1: {
HXLINE(1037)					if ((this->f != (int)0)) {
HXLINE(1037)						minFilter = (int)9985;
            					}
            					else {
HXLINE(1037)						minFilter = (int)9984;
            					}
            				}
            				break;
            				case (int)2: {
HXLINE(1042)					if ((this->f != (int)0)) {
HXLINE(1042)						minFilter = (int)9987;
            					}
            					else {
HXLINE(1042)						minFilter = (int)9986;
            					}
            				}
            				break;
            				default:{
HXLINE(1046)					HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,null()));
            				}
            			}
            		}
HXLINE(1051)		{
HXLINE(1051)			int _g2 = this->w;
HXDLIN(1051)			switch((int)(_g2)){
            				case (int)0: {
HXLINE(1055)					wrapModeS = (int)33071;
HXLINE(1056)					wrapModeT = (int)33071;
            				}
            				break;
            				case (int)1: {
HXLINE(1060)					wrapModeS = (int)10497;
HXLINE(1061)					wrapModeT = (int)10497;
            				}
            				break;
            				default:{
...
HXLINE(1069)		bool ignoreSampler = (((int)this->s & (int)(int)4) == (int)4);
HXLINE(1070)		bool centroid = (((int)this->s & (int)(int)1) == (int)1);
HXLINE(1071)		bool textureAlpha = (this->t == (int)2);
HXLINE(1074)		Float lodBias = ((Float)((int)((int)this->b << (int)(int)24) >> (int)(int)24) / (Float)((Float)8.0));
HXLINE(1075)		Float maxAniso = ((Float)0.0);
HXLINE(1077)		return  ::openfl::_internal::stage3D::SamplerState_obj::__alloc( HX_CTX ,minFilter,magFilter,wrapModeS,wrapModeT,lodBias,maxAniso,ignoreSampler,centroid,false,textureAlpha);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(SamplerRegister_obj,toSamplerState,return )
 ...
 ::openfl::_internal::stage3D::_AGALConverter::SamplerRegister SamplerRegister_obj::parse( cpp::Int64Struct v, ::openfl::_internal::stage3D::_AGALConverter::ProgramType programType){
            	HX_GC_STACKFRAME(&_hx_pos_4fd42e04ab930eb2_984_parse)
HXLINE( 986)		 ::openfl::_internal::stage3D::_AGALConverter::SamplerRegister sr =  ::openfl::_internal::stage3D::_AGALConverter::SamplerRegister_obj::__alloc( HX_CTX );
HXLINE( 987)		sr->programType = programType;
HXLINE( 988)		 cpp::Int64Struct a = _hx_int64_shr(v,(int)60);
HXDLIN( 988)		sr->f = _hx_int64_low(_hx_int64_and(a,( ::cpp::Int64Struct((int)15))));
HXLINE( 989)		 cpp::Int64Struct a1 = _hx_int64_shr(v,(int)56);
HXDLIN( 989)		sr->m = _hx_int64_low(_hx_int64_and(a1,( ::cpp::Int64Struct((int)15))));
HXLINE( 990)		 cpp::Int64Struct a2 = _hx_int64_shr(v,(int)52);
HXDLIN( 990)		sr->w = _hx_int64_low(_hx_int64_and(a2,( ::cpp::Int64Struct((int)15))));
HXLINE( 991)		 cpp::Int64Struct a3 = _hx_int64_shr(v,(int)48);
HXDLIN( 991)		sr->s = _hx_int64_low(_hx_int64_and(a3,( ::cpp::Int64Struct((int)15))));
HXLINE( 992)		 cpp::Int64Struct a4 = _hx_int64_shr(v,(int)44);
HXDLIN( 992)		sr->d = _hx_int64_low(_hx_int64_and(a4,( ::cpp::Int64Struct((int)15))));
HXLINE( 993)		 cpp::Int64Struct a5 = _hx_int64_shr(v,(int)40);
HXDLIN( 993)		sr->t = _hx_int64_low(_hx_int64_and(a5,( ::cpp::Int64Struct((int)15))));
HXLINE( 994)		 cpp::Int64Struct a6 = _hx_int64_shr(v,(int)32);
HXDLIN( 994)		sr->type = _hx_int64_low(_hx_int64_and(a6,( ::cpp::Int64Struct((int)15))));
HXLINE( 995)		 cpp::Int64Struct a7 = _hx_int64_shr(v,(int)16);
HXDLIN( 995)		sr->b = _hx_int64_low(_hx_int64_and(a7,( ::cpp::Int64Struct((int)255))));
HXLINE( 996)		sr->n = _hx_int64_low(_hx_int64_and(v,( ::cpp::Int64Struct((int)65535))));
HXLINE( 997)		return sr;
            	}
