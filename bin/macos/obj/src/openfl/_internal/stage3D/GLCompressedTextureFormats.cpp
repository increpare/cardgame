...
HX_LOCAL_STACK_FRAME(_hx_pos_0594741cd2107140_75_checkPVRTC,"openfl._internal.stage3D.GLCompressedTextureFormats","checkPVRTC",0xc1b35ceb,"openfl._internal.stage3D.GLCompressedTextureFormats.checkPVRTC","openfl/_internal/stage3D/GLCompressedTextureFormats.hx",75,0x2202e8a5)
HX_LOCAL_STACK_FRAME(_hx_pos_0594741cd2107140_96_toTextureFormat,"openfl._internal.stage3D.GLCompressedTextureFormats","toTextureFormat",0x8c1b5a3f,"openfl._internal.stage3D.GLCompressedTextureFormats.toTextureFormat","openfl/_internal/stage3D/GLCompressedTextureFormats.hx",96,0x2202e8a5)
namespace openfl{
namespace _internal{
namespace stage3D{
...
HXLINE(  62)		 ::Dynamic compressedExtension = gl->getExtension(HX_("OES_compressed_ETC1_RGB8_texture",cd,f1,a0,b8));
HXLINE(  63)		if (hx::IsNotNull( compressedExtension )) {
HXLINE(  65)			{
HXLINE(  65)				int v = ( (int)(compressedExtension->__Field(HX_("ETC1_RGB8_OES",ab,04,61,eb),hx::paccDynamic)) );
HXDLIN(  65)				this->_hx___formatMap->set((int)2,v);
            			}
HXLINE(  66)			{
HXLINE(  66)				int v1 = ( (int)(compressedExtension->__Field(HX_("ETC1_RGB8_OES",ab,04,61,eb),hx::paccDynamic)) );
HXDLIN(  66)				this->_hx___formatMapAlpha->set((int)2,v1);
            			}
            		}
            	}
...
void GLCompressedTextureFormats_obj::checkPVRTC( ::lime::_backend::native::NativeGLRenderContext gl){
            	HX_STACKFRAME(&_hx_pos_0594741cd2107140_75_checkPVRTC)
HXLINE(  81)		 ::Dynamic compressedExtension = gl->getExtension(HX_("IMG_texture_compression_pvrtc",02,61,85,d1));
HXLINE(  84)		if (hx::IsNotNull( compressedExtension )) {
HXLINE(  86)			{
HXLINE(  86)				int v = ( (int)(compressedExtension->__Field(HX_("COMPRESSED_RGB_PVRTC_4BPPV1_IMG",a1,18,41,ce),hx::paccDynamic)) );
HXDLIN(  86)				this->_hx___formatMap->set((int)1,v);
            			}
HXLINE(  87)			{
HXLINE(  87)				int v1 = ( (int)(compressedExtension->__Field(HX_("COMPRESSED_RGBA_PVRTC_4BPPV1_IMG",be,45,75,bf),hx::paccDynamic)) );
HXDLIN(  87)				this->_hx___formatMapAlpha->set((int)1,v1);
            			}
            		}
            	}
...
int GLCompressedTextureFormats_obj::toTextureFormat(bool alpha,int gpuFormat){
            	HX_STACKFRAME(&_hx_pos_0594741cd2107140_96_toTextureFormat)
HXDLIN(  96)		if (alpha) {
HXLINE(  98)			return ( (int)(this->_hx___formatMapAlpha->get(gpuFormat)) );
            		}
            		else {
HXLINE( 102)			return ( (int)(this->_hx___formatMap->get(gpuFormat)) );
            		}
