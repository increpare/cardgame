...
HX_DEFINE_STACK_FRAME(_hx_pos_9e15a0b592410441_25_new,"openfl._internal.stage3D.atf.ATFReader","new",0x0b38c27e,"openfl._internal.stage3D.atf.ATFReader.new","openfl/_internal/stage3D/atf/ATFReader.hx",25,0x63888776)
HX_LOCAL_STACK_FRAME(_hx_pos_9e15a0b592410441_77_readHeader,"openfl._internal.stage3D.atf.ATFReader","readHeader",0x33e29b25,"openfl._internal.stage3D.atf.ATFReader.readHeader","openfl/_internal/stage3D/atf/ATFReader.hx",77,0x63888776)
...
HX_LOCAL_STACK_FRAME(_hx_pos_9e15a0b592410441_158___readUInt24,"openfl._internal.stage3D.atf.ATFReader","__readUInt24",0xb1c572f4,"openfl._internal.stage3D.atf.ATFReader.__readUInt24","openfl/_internal/stage3D/atf/ATFReader.hx",158,0x63888776)
HX_LOCAL_STACK_FRAME(_hx_pos_9e15a0b592410441_169___readUInt32,"openfl._internal.stage3D.atf.ATFReader","__readUInt32",0xb1c573d1,"openfl._internal.stage3D.atf.ATFReader.__readUInt32","openfl/_internal/stage3D/atf/ATFReader.hx",169,0x63888776)
namespace openfl{
namespace _internal{
namespace stage3D{
namespace atf{
...
void ATFReader_obj::__construct( ::openfl::utils::ByteArrayData data,int byteArrayOffset){
            	HX_GC_STACKFRAME(&_hx_pos_9e15a0b592410441_25_new)
HXLINE(  33)		this->version = (int)0;
HXLINE(  39)		data->position = byteArrayOffset;
HXLINE(  40)		::String signature = data->readUTFBytes((int)3);
HXLINE(  41)		data->position = byteArrayOffset;
HXLINE(  43)		if ((signature != HX_("ATF",f3,9b,31,00))) {
HXLINE(  45)			HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,HX_("ATF signature not found",a0,f7,2f,3a)));
            		}
HXLINE(  49)		int length = (int)0;
HXLINE(  52)		if ((data->b->__get((byteArrayOffset + (int)6)) == (int)255)) {
HXLINE(  54)			this->version = data->b->__get((byteArrayOffset + (int)7));
HXLINE(  55)			data->position = (byteArrayOffset + (int)8);
HXLINE(  56)			length = this->_hx___readUInt32(data);
            		}
            		else {
HXLINE(  60)			this->version = (int)0;
HXLINE(  61)			data->position = (byteArrayOffset + (int)3);
HXLINE(  62)			length = this->_hx___readUInt24(data);
            		}
HXLINE(  66)		int _hx_tmp = (byteArrayOffset + length);
HXDLIN(  66)		if ((_hx_tmp > ::openfl::utils::_ByteArray::ByteArray_Impl__obj::get_length(data))) {
...
bool ATFReader_obj::readHeader(int _hx___width,int _hx___height,bool cubeMap){
            	HX_GC_STACKFRAME(&_hx_pos_9e15a0b592410441_77_readHeader)
HXLINE(  79)		int tdata = this->data->readUnsignedByte();
HXLINE(  80)		int type = ((int)tdata >> (int)(int)7);
HXLINE(  82)		bool _hx_tmp;
HXDLIN(  82)		if (!(cubeMap)) {
HXLINE(  82)			_hx_tmp = (type != (int)0);
            		}
            		else {
HXLINE(  82)			_hx_tmp = false;
            		}
HXDLIN(  82)		if (_hx_tmp) {
HXLINE(  84)			HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,HX_("ATF Cube map not expected",a7,74,ca,c8)));
            		}
HXLINE(  88)		bool _hx_tmp1;
HXDLIN(  88)		if (cubeMap) {
HXLINE(  88)			_hx_tmp1 = (type != (int)1);
            		}
            		else {
HXLINE(  88)			_hx_tmp1 = false;
            		}
HXDLIN(  88)		if (_hx_tmp1) {
HXLINE(  90)			HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,HX_("ATF Cube map expected",fa,fe,ed,52)));
            		}
HXLINE(  94)		this->cubeMap = cubeMap;
HXLINE(  96)		this->atfFormat = ((int)tdata & (int)(int)127);
HXLINE(  99)		bool _hx_tmp2;
HXDLIN(  99)		if ((this->atfFormat != (int)3)) {
HXLINE(  99)			_hx_tmp2 = (this->atfFormat != (int)5);
            		}
            		else {
HXLINE(  99)			_hx_tmp2 = false;
            		}
HXDLIN(  99)		if (_hx_tmp2) {
HXLINE( 101)			HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,HX_("Only ATF block compressed textures without JPEG-XR+LZMA are supported",25,8c,50,6a)));
            		}
...
HXLINE( 116)		return (this->atfFormat == (int)5);
            	}
...
HXDLIN( 146)									uploadCallback(side,level,gpuFormat,_hx_tmp3,((int)this->height >> (int)level),blockLength,bytes);
            								}
            							}
            						}
            					}
...
int ATFReader_obj::_hx___readUInt24( ::openfl::utils::ByteArrayData data){
            	HX_STACKFRAME(&_hx_pos_9e15a0b592410441_158___readUInt24)
HXLINE( 160)		int value = ((int)data->readUnsignedByte() << (int)(int)16);
HXLINE( 162)		value = ((int)value | (int)((int)data->readUnsignedByte() << (int)(int)8));
HXLINE( 163)		value = ((int)value | (int)data->readUnsignedByte());
...
int ATFReader_obj::_hx___readUInt32( ::openfl::utils::ByteArrayData data){
            	HX_STACKFRAME(&_hx_pos_9e15a0b592410441_169___readUInt32)
HXLINE( 171)		int value = ((int)data->readUnsignedByte() << (int)(int)24);
HXLINE( 173)		value = ((int)value | (int)((int)data->readUnsignedByte() << (int)(int)16));
HXLINE( 174)		value = ((int)value | (int)((int)data->readUnsignedByte() << (int)(int)8));
HXLINE( 175)		value = ((int)value | (int)data->readUnsignedByte());
