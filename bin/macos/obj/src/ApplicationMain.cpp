...
HXLINE(  23)		::String projectName = HX_("truetypefonts",bc,a1,bc,db);
HXLINE(  25)		 ::Dynamic config =  ::Dynamic(hx::Anon_obj::Create(9)
            			...
            			->setFixed(2,HX_("windows",83,de,74,e8),::Array_obj< ::Dynamic>::__new(1)->init(0, ::Dynamic(hx::Anon_obj::Create(22)
            				...
            				->setFixed(3,HX_("width",06,b6,62,ca),(int)840)
            				...
            				->setFixed(9,HX_("height",e7,07,4c,02),(int)860)
            				->setFixed(10,HX_("title",98,15,3b,10),HX_("Truetype Fonts",ac,16,e2,7b))
            			...
            			->setFixed(5,HX_("packageName",f1,04,ad,04),HX_("com.yournamehere.truetypefonts",c9,8e,2a,49))
            			->setFixed(6,HX_("file",7c,ce,bb,43),HX_("truetypefonts",bc,a1,bc,db))
            			->setFixed(7,HX_("name",4b,72,ff,48),HX_("Truetype Fonts",ac,16,e2,7b))
