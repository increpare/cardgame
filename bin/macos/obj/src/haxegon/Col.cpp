...
HXDLIN( 140)		_hx_tmp[(int)0] = (hk + ((Float)0.333333333333333315));
HXLINE( 141)		::haxegon::Col_obj::hslval[(int)1] = hk;
HXLINE( 142)		::Array< Float > _hx_tmp1 = ::haxegon::Col_obj::hslval;
HXDLIN( 142)		_hx_tmp1[(int)2] = (hk - ((Float)0.333333333333333315));
HXLINE( 143)		{
...
HXDLIN( 146)				if ((::haxegon::Col_obj::hslval->__get(n) < ((Float)0.166666666666666657))) {
