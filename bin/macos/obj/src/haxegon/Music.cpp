...
void Music_obj::play(::String soundname,hx::Null< Float >  __o_fadeintime,hx::Null< bool >  __o_loop,hx::Null< Float >  __o_volume,hx::Null< Float >  __o_panning){
...
HXLINE(   9)			::haxegon::Sound_obj::play(soundname,fadeintime,loop,volume,panning);
...
HXLINE(  13)				::haxegon::Sound_obj::play(soundname,::Std_obj::_hx_int(::Math_obj::max(fadeintime,::haxegon::Music_obj::crossfade)),loop,volume,panning);
HXLINE(  14)				::haxegon::Music_obj::_currentsong = soundname;
            			}
            			else {
HXLINE(  15)				if (!(::haxegon::Sound_obj::isplaying(soundname))) {
HXLINE(  16)					::haxegon::Sound_obj::play(soundname,fadeintime,loop,volume,panning);
