...
HX_LOCAL_STACK_FRAME(_hx_pos_82f6ad205dabc785_8_toint,"haxegon.Convert","toint",0x6ddc196b,"haxegon.Convert.toint","haxegon/Convert.hx",8,0x9363eeda)
HX_LOCAL_STACK_FRAME(_hx_pos_82f6ad205dabc785_18_tofloat,"haxegon.Convert","tofloat",0xf49be918,"haxegon.Convert.tofloat","haxegon/Convert.hx",18,0x9363eeda)
namespace haxegon{
...
int Convert_obj::toint( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_82f6ad205dabc785_8_toint)
HXLINE(   9)		if (::Std_obj::is(value,hx::ClassOf< int >())) {
HXLINE(  10)			return ( (int)(value) );
            		}
            		else {
HXLINE(  11)			if (::Std_obj::is(value,hx::ClassOf< ::Float >())) {
HXLINE(  12)				return ::Std_obj::_hx_int(( (Float)(value) ));
            			}
            		}
HXLINE(  14)		return ::Std_obj::parseInt(::Std_obj::string(value));
            	}
...
Float Convert_obj::tofloat( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_82f6ad205dabc785_18_tofloat)
HXDLIN(  18)		return ::Std_obj::parseFloat(( (::String)(value) ));
            	}
